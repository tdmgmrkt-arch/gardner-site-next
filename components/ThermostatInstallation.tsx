...
// ─── Image prompt constants (sourced from seo/hvac-image-prompts/thermostat-installation.md) ───
...
const services = [
  {
    ...
    description:
      "Nest, ecobee, Honeywell Home, and Carrier HVAC thermostats — installed, wired, and fully configured for your AC or heat pump system.",
    features: [
      "Nest & ecobee Compatible",
      "Wi-Fi Configuration",
  ...
  },
  {
    ...
    description:
      "Replacing a basic manual thermostat with a programmable unit — 7-day scheduling, setback programming, and energy savings calibrated to IE summer and winter patterns.",
    features: [
      "7-Day Schedule Setup",
      "Setback Programming",
  ...
  },
  {
    ...
    description:
      "AC or furnace not responding? We test the thermostat, wiring, and system response to isolate whether the thermostat is the cause before recommending replacement.",
    features: [
  ...
  },
  {
    ...
    description:
      "Two-stage AC systems and heat pumps require thermostats with specific wiring and configuration — a standard single-stage thermostat causes operational problems with these systems.",
    features: [
      "2-Stage System Compatible",
      "Heat Pump Auxiliary Heat",
      "Emergency Heat Mode",
      "Balance Point Configuration",
    ],
  },
];
...
const benefits = [
  {
    ...
    description:
      "Before recommending any thermostat, we verify it's compatible with your specific HVAC system — single-stage, two-stage, heat pump, or multi-zone.",
  },
  {
    icon: Settings,
    title: "Full Configuration, Not Just Install",
    description:
      "We don't leave until every mode is tested, the schedule is set, and the app is connected. Installation isn't done until the system responds correctly.",
  },
  {
    icon: Shield,
    title: "Licensed HVAC Technicians",
    description:
      "Every technician is licensed for HVAC work in California. Thermostat wiring touches your AC and furnace control boards — it's not a DIY job on modern systems.",
  },
  {
    icon: Award,
    title: "30+ Years Serving the IE",
    description:
      "Three decades in Riverside County means we've wired thermostats to every generation of HVAC system — from 1990s single-stage units to current multi-speed inverter-driven systems.",
  },
];
...
const faqs = [
  {
    ...
    answer: (
      <>
        The most common signs of a failing thermostat are: your AC or furnace
        doesn&apos;t turn on when the thermostat calls for it, the system runs
        continuously without reaching setpoint, the display is unresponsive or
        showing erratic readings, or the system short-cycles — turns on and off
        every few minutes. Before replacing the thermostat, our technicians test
        it to confirm it&apos;s actually the problem. A thermostat that
        isn&apos;t responding can sometimes indicate an{" "}
        <Link
        ...
        or a furnace control board problem rather than the thermostat itself.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        We install Nest (Google), ecobee, Honeywell Home (T6 and T9 series), and
        Carrier-brand HVAC thermostats. For standard central AC and furnace
        systems, all four are compatible with standard 5-wire Rh/Rc/Y/G/W
        wiring. Heat pump systems require thermostats with an O/B reversing valve
        wire, and two-stage systems require Y2 and W2 terminals — not every smart
        thermostat supports these without an adapter. We confirm wiring
        compatibility before ordering any equipment. Ask about{" "}
        <Link
        ...
        discounts that include thermostat service.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        This is one of the most common calls we receive. The usual causes are: a
        wire connected to the wrong terminal (common with heat pump O/B wiring),
        a missing C-wire causing the thermostat to power-steal from the Y
        terminal and confuse the control board, or a short caused by bare wire
        touching the sub-base. In most cases, we can correct the wiring and
        restore operation the same day. If the control board was damaged,
        that&apos;s an{" "}
        <Link
          href="/services/hvac/ac-repair"
          className="text-red-400 hover:text-red-300 underline"
        ...
        and may require a board replacement.
      </>
    ),
  },
  {
    question: "What is a C-wire and why does it matter for smart thermostats?",
    answer:
  ...
  },
  {
    ...
    answer: (
      <>
        A programmable or smart thermostat reduces cooling and heating energy use
        by 10–15% compared to a manual thermostat when properly configured with
        setback schedules. In the Inland Empire — where AC runs 5–6 months of
        the year — that translates to meaningful annual savings on Southern
        California Edison bills. The bigger efficiency gains come from getting
        the thermostat schedule right for your household, not from the hardware
        alone. Our technicians set up schedules during installation rather than
        leaving factory defaults in place. For system-level efficiency
...
export function ThermostatInstallation() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                A thermostat that isn&apos;t wired or configured correctly
                causes your AC and furnace to short-cycle, overshoot setpoints,
                or fail to respond. Our licensed HVAC technicians install and
                configure your thermostat to work precisely with your system.
              </p>

              {/* Key Benefits */}
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Thermometer, text: "HVAC System Compatibility" },
                  { icon: Shield, text: "Licensed & Insured" },
                  { icon: Settings, text: "Full Configuration Included" },
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/hvac/thermostat-installation-hero.webp"
                  alt="Gardner HVAC technician installing a smart thermostat on a wall in a Murrieta Inland Empire home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  AC or furnace not responding to the thermostat? That&apos;s a
                  diagnostic call — our HVAC team identifies the actual cause.
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Thermostat, wiring, or system — we diagnose all three
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Thermostat installation in Murrieta isn&apos;t just swapping
              hardware — it&apos;s making sure the new thermostat communicates
              correctly with your specific AC system, heat pump, or furnace.
              Wiring configurations vary by system type, and a mismatch causes
              problems ranging from short-cycling to complete system lockout.
              Our HVAC technicians confirm compatibility, wire correctly, and
              configure the thermostat before leaving. View all{" "}
              <Link
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-white mb-6">
                  What&apos;s Different After a Professional Thermostat
                  Installation
                </h3>
                <div className="space-y-4 text-gray-300">
                  {[
                    "Thermostat communicates correctly with your specific AC, heat pump, or furnace",
                    "All wires labeled, terminated cleanly, and confirmed with a system test",
                    "Cooling and heating modes tested through full cycles before job is complete",
                    "Schedule programmed to match your household patterns — not factory defaults",
                    "App access configured and confirmed working on your phone before we leave",
                    "Old thermostat and wiring assessed — any corroded or damaged wires replaced",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/hvac/thermostat-installation-before-after.webp"
                    alt="Before and after thermostat upgrade showing old beige thermostat replaced with modern smart thermostat by Gardner HVAC in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. HVAC technician and service van ready for thermostat installation"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our HVAC technicians have installed and configured over 300
                thermostats across Riverside County — including smart thermostat
                upgrades on multi-stage AC systems, heat pump configurations in
                Canyon Lake, and programmable replacements in Hemet. If your AC
                isn&apos;t responding to the thermostat, that may be an{" "}
                <Link
                  href="/services/hvac/ac-repair"
                  className="text-red-400 hover:text-red-300 underline"
                >
                ...
                rather than a thermostat problem — we diagnose both.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Thermostat installation service is available across the Inland
              Empire, dispatched from our Murrieta base. We serve Temecula,
              Menifee, Perris, Canyon Lake, Lake Elsinore, Corona, Moreno
              Valley, Riverside, and Hemet — with same-week scheduling
              throughout.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about thermostat installation in
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                schedule your thermostat installation. Need immediate help? Call
                our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                When Your Thermostat Problem Is{" "}
                <span className="text-gradient bg-gradient-to-r from-red-400 to-orange-500 bg-clip-text text-transparent">
                  Actually an HVAC Emergency
                </span>
              </h2>

              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                A thermostat that shows a setpoint but can&apos;t get the AC or
                furnace to respond isn&apos;t always a thermostat problem.
                Control board faults, blown fuses on the air handler, and wiring
                shorts can all present as thermostat failure. Our HVAC team
                diagnoses the actual cause — not just the symptom — and repairs
                the right component the same day.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner HVAC technician arriving for emergency thermostat diagnosis in the Inland Empire"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Thermostat installation across Murrieta, Temecula, and the
                Inland Empire. Full HVAC system compatibility verification,
                professional wiring, complete configuration. Call now or
                schedule online. View our{" "}
                <Link
                  href="/services/hvac/ac"
                  className="text-red-400 hover:text-red-300 underline"
                >
                ...
                — or if your AC isn&apos;t responding at all, our{" "}
                <Link
                  href="/services/hvac/ac-repair"
                  className="text-red-400 hover:text-red-300 underline"
                >
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-center text-sm max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">HVAC Compatibility</span>
              </div>
              <div className="flex items-center gap-2">

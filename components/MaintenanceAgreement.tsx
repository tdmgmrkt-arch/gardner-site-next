  ...
  <div className="flex items-center space-x-2 text-sm text-gray-400">
    <Breadcrumbs
      items={[
        ...
        { label: "Maintenance Agreement" } // no href = current page
      ]}
    />
  </div>
</nav>              {/* Badge */}
          ...
          <div className="glassmorphism-dark rounded-3xl p-8 lg:p-12 border border-white/10 shadow-luxury">
            <form className="space-y-8">
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                <Checkbox id="opt-in" className="mt-0.5 border-white/20 data-[state=checked]:bg-green-500 data-[state=checked]:border-green-500 flex-shrink-0" required />

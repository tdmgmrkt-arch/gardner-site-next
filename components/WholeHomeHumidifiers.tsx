...
// ─── Image prompt constants (sourced from seo/hvac-image-prompts/whole-home-humidifiers.md) ───

const HERO_PROMPT =
  "Photo of an HVAC technician mounting a bypass whole-home humidifier unit onto the supply plenum of a residential furnace in a utility closet, securing the unit with a drill, a small copper water supply line already connected to the saddle valve below. Technician is wearing a light gray button-up work shirt with a red Gardner Plumbing Co. patch on the left chest, navy work pants, dark navy ball cap with red Gardner logo, black work boots, red Milwaukee tool bag on hip. Humidifier cabinet flush against the sheet metal plenum, bypass duct tube partially installed. Concrete floor, warm garage ambient light. 50mm equivalent lens, documentary photography style. No studio lighting. Style and likeness of attached reference image.";

const HERO_NEGATIVE =
  "no stock photo look, no white lab coat, no safety vest, no Carhartt tan jacket, no orange or yellow hi-vis vest, no cartoon, no illustration, no text overlay, no watermark, no portable room humidifier (wrong product), no steam or mist theatrics, no excessive lens flare, no outdoor setting";
...
const BEFORE_AFTER_PROMPT =
  "Split-scene product photograph, single frame divided at vertical center. LEFT HALF: a circular wall-mounted hygrometer gauge showing a low indoor humidity reading of 20 percent, face of the gauge clear and sharp against a neutral interior wall. RIGHT HALF: the same style hygrometer gauge showing a comfortable indoor humidity reading of 45 percent, same wall, same framing. Seamless lighting match across both halves, straight-on 35mm lens, no people, no hands, technical documentation style. Warm neutral interior ambient light, clean white or off-white wall background.";

const BEFORE_AFTER_NEGATIVE =
  "no people, no hands visible, no text overlay (other than gauge numbers), no cartoon, no split-screen border or line artifact, no wildly different lighting between halves, no stock photo softness, no watermark, no portable humidifier, no cracked wood or skin imagery, no dramatic steam effects";
...
const services = [
  {
    ...
    description:
      "The most common whole-home type — mounts on the supply or return plenum and feeds water-vapor through a bypass duct when the furnace runs. Low maintenance, reliable, and competitively priced.",
    features: [
      "Supply or Return Mount",
      "Works with Existing Furnace",
      "Automatic Humidity Control",
      "Annual Media Pad Service",
    ],
  },
  {
    icon: Zap,
    ...
    description:
      "Fan-powered models use an internal fan to push air through the water panel continuously — more output than a bypass unit, making them the right choice for larger Inland Empire homes over 2,500 sq ft.",
    features: [
      "Higher Output Than Bypass",
      "Runs Without Furnace Heat",
  ...
  },
  {
    ...
    description:
      "Steam humidifiers boil water and inject pure steam into the ductwork — the most precise humidity control available and the only type that works independently of furnace operation.",
    features: [
      "Works Without Furnace On",
      "Most Precise Control",
      "Ideal for Tight Humidity Requirements",
      "Annual Canister Flush Service",
    ],
  },
  {
    icon: Settings,
    ...
    description:
      "Every whole-home humidifier we install includes a calibrated humidistat — the humidity equivalent of a thermostat. Smart-thermostat integration (Ecobee, Nest) is available for homes already running smart HVAC controls.",
    features: [
      "Dedicated Humidistat Install",
      "Smart Thermostat Integration",
      "Outdoor Sensor Calibration",
      "Seasonal Setting Adjustment",
    ],
  },
];
...
const benefits = [
  {
    ...
    description:
      "Whole-home humidifiers connect to your water line, your furnace, and your ductwork. Our team handles all three — no contractor coordination required.",
  },
  {
    icon: Award,
    title: "Right Model for Your Home",
    description:
      "Bypass, fan-powered, or steam — the right choice depends on your furnace type, home size, and existing ductwork layout. We assess before we quote.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "Humidifier installation pairs well with air filtration systems — moisture and clean air together address the full range of indoor air quality concerns common in IE homes.",
  },
];
...
const faqs = [
  {
    ...
    answer: (
      <>
        Many IE residents are surprised to learn that inland Southern California
        winters are genuinely dry — not the tropical humidity that coastal LA can
        bring. Murrieta, Temecula, and especially Hemet and Lake Elsinore see
        winter indoor humidity levels regularly drop below 25%. The EPA
        recommends indoor humidity in the 30–50% range for occupant health and
        home material preservation. If you&apos;re waking up with dry sinuses,
        noticing static electricity buildup, or watching wood furniture crack in
        winter, your home&apos;s humidity is likely too low. See all of our{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        Dry air is a documented trigger for both conditions. Humidity below 30%
        increases the concentration of airborne particulates and exacerbates skin
        barrier breakdown in eczema patients. Whole-home humidification that
        maintains 35–45% relative humidity consistently has been shown in
        clinical literature to reduce the frequency of asthma and eczema
        flare-ups associated with dry air. We&apos;d recommend pairing
        ...
        awareness check — you want to stay in the 35–50% range, not push past
        55% into mold territory.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Bypass and fan-powered models use a replaceable water panel (also called
        a media pad or evaporator pad) that needs replacement once per heating
        season — typically October or November before winter humidity demands
        increase. Steam humidifiers require an annual canister flush to remove
        mineral buildup from the heating element. The humidistat should be
        calibrated annually to ensure accurate readings, which we do as part of
        our{" "}
        <Link
        ...
        visits. Total annual maintenance time is under 30 minutes per year for
        the homeowner; professional service runs about 20 minutes added to an
        annual HVAC visit.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Bypass and fan-powered models run in the $400–$700 installed range for
        most Inland Empire homes — the variance depends on the complexity of the
        plenum connection and the length of the water supply run. Steam
        humidifiers are more complex and typically run $600–$1,100 installed.
        These are general ranges — actual pricing depends on your specific
        furnace and ductwork layout, which our technician assesses on site before
        quoting. We provide a written quote before any work starts. Financing
        options are available through our{" "}
        <Link
          href="/financing"
          className="text-red-400 hover:text-red-300 underline"
        >
        ...
        for customers who prefer to spread the cost.
      </>
    ),
  },
];
...
export function WholeHomeHumidifiers() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Inland Empire winters are drier than most California residents
                expect. Whole-home humidifiers integrate directly with your
                furnace or air handler to add balanced moisture to every room —
                no countertop units, no constant refilling.
              </p>

              {/* Key Benefits */}
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Droplets, text: "Whole-Home Humidity Control" },
                  { icon: Shield, text: "Licensed HVAC Installation" },
                  { icon: Heart, text: "Relieves Sinus, Skin & Static Issues" },
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/whole-home-humidifiers-hero.webp"
                  alt="Gardner HVAC technician installing a whole-home bypass humidifier on a furnace plenum in a Murrieta Inland Empire home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Dry sinuses, cracked skin, or static shocks all winter?
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Whole-home humidifiers installed across the IE
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              The Inland Empire&apos;s desert-adjacent climate produces winter
              indoor humidity levels that can drop below 20% — well under the
              35–50% range that keeps occupants comfortable and homes intact.
              Whole home humidifier installation adds controlled moisture into
              your HVAC&apos;s airstream so every room maintains consistent
              humidity automatically, without portable units to fill, move, or
              forget about.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "Morning dry-throat and sinus discomfort reduced within days of install",
                    "Static electricity in carpets and on doorknobs eliminated",
                    "Wood furniture, cabinetry, and hardwood floors stop cracking and warping",
                    "Skin and eczema symptoms improve as indoor air holds adequate moisture",
                    "HVAC system runs more efficiently — humid air holds heat better than dry air",
                    "Consistent humidity maintained automatically — no manual refilling or moving units",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/hvac/whole-home-humidifiers-before-after.webp"
                    alt="Before and after whole-home humidifier installation showing indoor humidity rising from 20 percent to 45 percent by Gardner HVAC in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. HVAC technician and service van ready for whole-home humidifier installation"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Whole-home humidifier installation requires connecting to your
                furnace&apos;s electrical system, your home&apos;s water supply
                line, and the ductwork plenum — three systems that cross HVAC and
                plumbing. Our team handles the full integration on one visit, with
                no need to coordinate a separate plumber and a separate HVAC
                tech. Pair with{" "}
                <Link
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Whole-home humidifier installation is available across the Inland
              Empire, with fast scheduling from our Murrieta base. We serve
              Temecula, Menifee, Perris, Canyon Lake, Lake Elsinore, Corona,
              Moreno Valley, Riverside, and Hemet — including the drier inland
              communities where humidity levels drop lowest in winter.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about whole-home humidifier
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                technicians are standing by to help. Call{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Dry-air symptoms — nosebleeds, cracked skin, static electricity,
                and chronic sinus irritation — aren&apos;t emergencies in the
                classic sense. But for households with asthma, eczema, or young
                children, a winter without adequate indoor humidity can feel like
                one. Our scheduling line is open Monday through Saturday, with
                same-week availability.
              </p>

              <div className="mb-8">
                <h3 className="text-xl font-bold text-white mb-6">
                  Situations That Move Humidification Up the List:
                </h3>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner HVAC team arriving for whole-home humidifier installation in the Inland Empire"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3 drop-shadow-lg">
                Ready to Fix Your Home&apos;s{" "}
                <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">
                  Dry Air Problem?
                </span>
              </h2>
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Whole home humidifier installation across Murrieta, Temecula,
                and the Inland Empire. Bypass, fan-powered, and steam models.
                HVAC and plumbing integration in one visit. Call now or schedule
                your assessment online — same-week availability.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-center text-sm max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">All Humidifier Types</span>
              </div>
              <div className="flex items-center gap-2">

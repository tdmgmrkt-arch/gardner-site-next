...
// ─── Image prompt constants (sourced from seo/electrical-image-prompts/electrical-panel-upgrade.md) ───
...
const services = [
  {
    ...
    description:
      "The most common upgrade in the Inland Empire. A 200-amp service handles modern electric loads — including EV chargers and heat pumps — without tripping breakers or overloading circuits.",
    features: [
  ...
  },
  {
    ...
    description:
      "Old or failing breaker panels — including recalled Zinsco and Federal Pacific panels common in 1970s-90s IE builds — are a fire hazard. We replace them with modern Square D or Leviton panels rated for today's loads.",
    features: [
      "Hazardous Panel Removal",
      "Modern Panel Install",
      "All Breakers Tested",
  ...
  },
  {
    ...
    description:
      "Adding a garage, ADU, workshop, or pool equipment pad in Murrieta or Temecula? A sub-panel feeds that dedicated space without overloading the main service entrance.",
    features: [
      "ADU Sub-Panel Wiring",
      "Garage & Workshop Circuits",
      "Pool Equipment Feeds",
      "Dedicated Circuit Routing",
    ],
  },
  {
    icon: Star,
    ...
    description:
      "SoCal Edison has specific requirements for service entrance conductors, meter bases, and clearances when upgrading from 100A to 200A. We coordinate directly with SCE so the utility side and the panel side meet code on the same inspection.",
    features: [
...
const benefits = [
  ...
  },
  {
    ...
    description:
      "Every tech on our electrical team holds a valid CA C-10 license and passes background verification before working in your home.",
  },
  {
    icon: DollarSign,
    title: "Upfront, Written Quotes",
    description:
      "You receive a written quote after the load calculation — before any work begins. The quote price is the invoice price. No add-ons after the panel is open.",
  },
  {
    icon: Award,
    title: "SCE-Savvy Coordination",
    description:
      "We handle SoCal Edison coordination directly — scheduling the utility disconnect, meter base upgrade, and reconnect so the homeowner doesn't have to manage a utility work order.",
  },
];
...
const faqs = [
  {
    ...
    answer: (
      <>
        Four situations consistently point to a panel upgrade. First, you&apos;re
        adding a high-draw appliance — an EV charger, heat pump, or hot tub — and
        there&apos;s no capacity left in the panel. Second, breakers trip regularly
        under normal household load. Third, you&apos;re planning an ADU or room
        addition that requires new circuits. Fourth, your home still has a 100-amp
        service, which is undersized for most modern Inland Empire households. Our
        electricians do a load calculation at the start of every job — that number
        tells us exactly what your panel can and cannot support. For EV charger
        installs specifically, see our{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        Our electricians install Square D QO and Homeline panels as the primary
        preference — both are widely available, well-supported for future breaker
        additions, and accepted by Murrieta and Riverside County inspectors without
        issue. Leviton and Eaton panels are also used for specific load
        configurations. We do not install panels from brands with known historical
        defect issues (Zinsco, Federal Pacific Stab-Lok). If your home currently
        has one of these panels, the upgrade is a safety priority regardless of
        capacity. Our{" "}
        <Link
        ...
        covers what to do when the wiring behind the panel also needs attention.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        A panel upgrade itself does not directly reduce electricity consumption —
        it increases your home&apos;s electrical capacity. Indirectly, it enables
        the appliance changes that do reduce bills: replacing a gas appliance with
        a modern heat pump, adding an EV charger that uses off-peak rates, or
        eliminating overloaded circuits that cause phantom draw. If energy savings
        are a priority, ask our electricians about load management during the quote
        visit — we can flag which circuits are drawing more than expected and where
        the upgrade creates the most efficiency opportunity. Financing is available
        for panel upgrades; see our{" "}
        <Link
          href="/financing"
          className="text-red-400 hover:text-red-300 underline"
        >
...
export function ElectricalPanelUpgrade() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4 drop-shadow-lg leading-tight">
                Electrical Panel Upgrade in Murrieta —{" "}
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/electrical-panel-upgrade-hero.webp"
                  alt="Gardner electrician upgrading residential electrical panel in a Murrieta garage"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Planning an EV charger, heat pump, or ADU in Murrieta?
                </span>
              </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white text-center mb-8 drop-shadow-lg">
              Electrical Panel Upgrade Services in the{" "}
              <span className="text-gradient bg-gradient-to-r from-yellow-400 to-red-500 bg-clip-text text-transparent">
                Inland Empire
              </span>
            </h2>
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Most Inland Empire homes built before 2010 carry a 100-amp or
              150-amp main panel. That was adequate for the appliances of the
              time. Today&apos;s homes — running EV chargers, heat pumps,
              whole-home generators, and multiple high-draw kitchen circuits —
              regularly exceed that capacity. Our electricians assess your load,
              size the right panel, and handle the full upgrade from SCE
              coordination to final inspection. View our{" "}
              <Link
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "Full 200-amp capacity — room for EV chargers, heat pumps, and future loads",
                    "Breakers reset cleanly and hold — no more nuisance trips",
                    "All circuits labeled accurately on the new panel directory",
                    "SCE inspection signed off — utility reconnect confirmed",
                    "Grounding and bonding verified to current NEC standards",
                    "Rebate documentation submitted to SCE where eligible",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/electrical-panel-upgrade-before-after.webp"
                    alt="Before and after electrical panel upgrade showing 100-amp panel replaced with 200-amp service by Gardner Electrical in Murrieta"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. electrician and service van ready for panel upgrade work"
                  fill
              ...
              <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury animate-fade-in bg-black/60 backdrop-blur-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300 text-xs">Panels Upgraded</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our electricians have completed over 200 panel upgrades across
                Riverside County — from replacing failed Federal Pacific panels in
                Riverside&apos;s older neighborhoods to upgrading 100A services in
                Murrieta tract homes ahead of EV charger and heat pump
                installations.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Electrical panel upgrade service is available across the Inland
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about electrical panel upgrades in
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                is standing by to answer your questions and schedule your panel
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                ...
                <span className="text-gradient bg-gradient-to-r from-red-400 to-orange-500 bg-clip-text text-transparent">
                  Urgent Panel Assessment
                </span>
              </h2>

              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Some panel problems are not planning decisions — they&apos;re
                safety events. A panel that sparks, runs hot to the touch, emits
                a burning odor, or trips a breaker that will not reset is a
                same-day call. Our electrical team responds to urgent panel
                situations across Murrieta and the Inland Empire seven days a
                week.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Emergency electrical service — Gardner electrician responding to panel problem"
                  width={1000}
                  height={700}

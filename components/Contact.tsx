...
const [schedulerOpen, setSchedulerOpen] = useState(false);
  ...
  },
  {
    icon: Mail,
    title: "Email",
    primary: "office@gardnerplumbingco.com.com",
    secondary: "Response within 24 hours",
    action: "Send Email",
    href: "mailto:office@gardnerplumbingco.com.com"   // 📧 Opens email client
  },
  {
    icon: MapPin,
    title: "Service Area",
    ...
    href: "/service-areas"   // 📍 Internal route or map link
  },
  {
    icon: Clock,
    title: "Office Hours",
  ...
  const cityLinks: Record<string, string> = {
    ...
    "Murrieta": "https://www.murrietaca.gov/",
    "Perris": "https://www.cityofperris.org/",
    "Menifee": "https://www.cityofmenifee.us/",
    "Canyon Lake": "https://www.canyonlakepoa.com/",
    "Lake Elsinore": "https://www.lake-elsinore.org/",
    "Corona": "https://www.coronaca.gov/",
    "Moreno Valley": "https://moval.gov/",
    "Riverside": "https://www.riversideca.gov/",
    "Wildomar": "https://wildomar.hdlgov.com/",
    "Winchester": "https://www.winchestermac.org/",
    "French Valley": "https://www.rivco.org/",
    "Sun City": "https://www.cityofmenifee.us/",
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {serviceAreas.map((area) => (
                    <a key={area} href={cityLinks[area]} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 p-2 hover:bg-white/5 rounded-lg transition-all duration-300 group">
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="space-y-4">
                  {emergencyServices.map((service) => {
                    ...
                    return (
                      <Link key={service.service} href={service.href} className="flex items-center gap-4 p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 group">

...
// ─── Image prompt constants (sourced from seo/hvac-image-prompts/air-filtration-systems.md) ───

const HERO_PROMPT =
  "Photo of an HVAC technician installing a thick media filter into a return air plenum cabinet beside a residential furnace in a utility closet, holding the filter media with both hands and sliding it into the metal filter cabinet housing. Technician is wearing a light gray button-up work shirt with a red Gardner Plumbing Co. patch on the left chest, navy work pants, dark navy ball cap with red Gardner logo, black work boots, red Milwaukee tool bag on hip. Four-inch thick MERV media filter clearly visible, new metal cabinet frame open, concrete floor, warm fluorescent garage light. 50mm equivalent lens, documentary photography style. No studio lighting. Style and likeness of attached reference image.";

const HERO_NEGATIVE =
  "no stock photo look, no white lab coat, no safety vest, no Carhartt tan jacket, no orange or yellow hi-vis vest, no cartoon, no illustration, no text overlay, no watermark, no industrial dust mask theatrics, no outdoor setting, no ceiling register filter (wrong product type), no excessive lens flare";
...
const BEFORE_AFTER_PROMPT =
  "Split-scene product photograph, single frame divided at vertical center. LEFT HALF: a standard 1-inch disposable fiberglass furnace filter — thin, flimsy, grey-white material, slightly dirty from use, in a basic filter slot. RIGHT HALF: a thick 4-to-5-inch deep-pleated MERV-13 media filter in a dedicated filter cabinet — dense accordion-fold media, robust frame, clearly far more capable than the thin filter on the left. Both shown at the same scale and angle for direct comparison. Seamless lighting match across both halves, straight-on 35mm lens, no people, no hands, technical documentation style. Neutral light utility background.";

const BEFORE_AFTER_NEGATIVE =
  "no people, no hands visible, no text overlay, no cartoon, no split-screen border or line artifact, no wildly different lighting between halves, no stock photo softness, no watermark, no HEPA filter (different product), no whole-house air purifier unit (different product)";
...
const services = [
  {
    ...
    description:
      "MERV 13–16 media filters installed in your existing air handler — capturing allergens, fine dust, and smoke particles that standard 1-inch filters miss entirely.",
    features: [
      "MERV 13 to MERV 16 Rating",
      "4–5 Inch Media Depth",
      "6–12 Month Filter Life",
      "Fits Existing Filter Housing",
    ],
  },
  {
    icon: Zap,
    ...
    description:
      "Whole-home electronic air cleaners use electrostatic charge to capture particles as small as 0.1 microns — the category that includes bacteria, fine smoke, and some viruses.",
    features: [
      "0.1 Micron Particle Capture",
      "Reusable Filter Cells",
      "No Disposable Filter Cost",
  ...
  },
  {
    ...
    description:
      "UV-C systems mount inside the air handler and use germicidal ultraviolet light to neutralize airborne pathogens passing through the coil section — a common add-on for allergy households.",
    features: [
      "Germicidal UV-C Wavelength",
      "Coil-Mount or In-Duct Install",
      "Targets Bacteria & Mold Spores",
      "Low Maintenance — Annual Bulb",
    ],
  },
  {
    icon: Filter,
    ...
    description:
      "Not sure which system fits your home? Our HVAC tech measures your air handler, checks existing filter housing dimensions, and recommends the highest-efficiency option your system can support without restricting airflow.",
    features: [
      "Air Handler Measurement",
      "Static Pressure Check",
      "MERV Rating Recommendation",
...
const benefits = [
  {
    ...
    description:
      "A MERV 16 filter on an underpowered air handler creates airflow restriction that damages the system. We measure first and install what fits.",
  },
  {
    icon: Award,
    title: "Full System Integration",
    description:
      "Your filtration system integrates with your existing AC and furnace — no new equipment, no separate maintenance schedule, no clutter.",
  },
  {
    icon: Shield,
    title: "Licensed HVAC Installation",
    description:
      "Electronic air cleaners and UV-C systems require electrical work inside the air handler cabinet. Every install is performed by a licensed HVAC technician.",
  },
  {
    icon: LinkIcon,
    title: "Start with Clean Ducts",
    description:
      "For best results, our team recommends air duct cleaning before filtration installation — clean ducts let your new system perform from day one instead of filtering existing debris first.",
  },
];
...
const faqs = [
  {
    ...
    answer: (
      <>
        Whole home air filtration installs directly into your HVAC system —
        typically at the air handler or furnace return side. Every time your
        system runs, all the air in your home passes through the filtration media
        before being distributed to each room. A portable air purifier handles
        the square footage of one room and only cleans air in its immediate
        vicinity. For a 2,000 square-foot Murrieta home, a single portable unit
        covers roughly 300–400 square feet. A whole-home system covers the entire
        living area simultaneously. See all of our{" "}
        <Link
  ...
  {
    question:
      "What MERV rating does my Inland Empire home actually need?",
    answer:
  ...
  {
    question:
      "How often does a whole-home media filter need to be replaced?",
    answer: (
      <>
        A 4-inch or 5-inch deep-media filter at MERV 13 typically lasts 6 to 12
        months under normal operating conditions. Homes with pets, high
        occupancy, or significant outdoor dust infiltration (common in Lake
        Elsinore, Hemet, and Perris) tend to run closer to the 6-month end. We
        recommend checking filter condition at every{" "}
        <Link
        ...
        and setting a calendar reminder 6 months after each replacement.
        Electronic air cleaner cells are reusable — they need washing every 3
        months, not replacement.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Done correctly, it should not reduce performance — and it often improves
        it. A clean, high-efficiency filter keeps the evaporator coil cleaner,
        which reduces the coil&apos;s resistance to heat transfer and improves
        cooling efficiency. The risk comes from installing too high a MERV rating
        without checking whether the air handler&apos;s blower can overcome the
        added static pressure. An under-powered blower working against a dense
        filter will run longer cycles, wear out faster, and reduce airflow to
        distant rooms. That&apos;s why our assessment step is not optional — it
        protects your equipment. Pair with{" "}
        <Link
...
export function AirFiltrationSystems() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4 drop-shadow-lg leading-tight">
                Whole Home Air Filtration in Murrieta —{" "}
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                A portable air purifier handles one room. A whole-home air
                filtration system cleans every cubic foot of air your HVAC moves
                — without the clutter, the filters to swap monthly, or the
                coverage gaps.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Wind, text: "Whole-Home Coverage" },
                  { icon: Shield, text: "Licensed HVAC Installation" },
                  { icon: Zap, text: "Works with Existing AC & Furnace" },
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/air-filtration-systems-hero.webp"
                  alt="Gardner HVAC technician installing a media air filtration system on a furnace plenum in a Murrieta Inland Empire home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Allergy season hits hard in the Inland Empire.
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Filtration assessments available this week
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Most Inland Empire homes run a standard 1-inch filter that catches
              large debris but does little for allergens, fine dust, or smoke
              particulates. Whole home air filtration upgrades the filtration
              media inside your existing HVAC system — so every room gets cleaner
              air every time the system runs, without any standalone devices to
              maintain or move.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "Allergens, pollen, and pet dander captured before reaching living spaces",
                    "Fine dust reduction visible on surfaces within weeks of install",
                    "Wildfire smoke particulates filtered during fire season events",
                    "HVAC system protected — cleaner air means less debris on the evaporator coil",
                    "Elimination of portable air purifier clutter in every room",
                    "Consistent air quality across all rooms — not just where a device sits",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/hvac/air-filtration-systems-before-after.webp"
                    alt="Before and after air filtration upgrade showing thin 1-inch disposable filter replaced with thick MERV-13 media filter by Gardner HVAC in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. HVAC technician and service van ready for air filtration installation"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Whole-home air filtration is not a plug-in product — it
                requires matching the filter system to your air handler&apos;s
                static pressure tolerance, your existing duct sizing, and your
                home&apos;s actual IAQ needs. Our technicians assess before they
                recommend, and they install what your system can actually support.
                We also recommend starting with{" "}
                <Link
                ...
                for best filtration results from day one.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Whole-home air filtration service is available across the Inland
              Empire, with fast scheduling from our Murrieta base. We serve
              Temecula, Menifee, Perris, Canyon Lake, Lake Elsinore, Corona,
              Moreno Valley, Riverside, and Hemet — same-week availability
              throughout.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about whole-home air filtration in
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                your air filtration assessment. Need to talk now? Call{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Most filtration installations are scheduled. But wildfire smoke
                events, a family member&apos;s new asthma diagnosis, or a sudden
                allergy spike can move IAQ from &quot;someday&quot; to &quot;this
                week.&quot; Our scheduling line is open Monday through Saturday,
                with same-week availability across the Inland Empire.
              </p>

              <div className="mb-8">
                <h3 className="text-xl font-bold text-white mb-6">
                  Situations That Move IAQ Up the Priority List:
                </h3>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner HVAC team arriving for air filtration assessment in the Inland Empire"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3 drop-shadow-lg">
                Ready to Upgrade Your Home&apos;s{" "}
                <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">
                  Air Filtration?
                </span>
              </h2>
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Whole home air filtration across Murrieta, Temecula, and the
                Inland Empire. MERV 13–16 media filters, electronic air cleaners,
                and UV-C upgrades — all integrated with your existing HVAC
                system. Call now or schedule your assessment online.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-center text-sm max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">MERV 13–16 Rated</span>
              </div>
              <div className="flex items-center gap-2">

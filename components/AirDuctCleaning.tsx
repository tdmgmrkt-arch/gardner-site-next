...
// ─── Image prompt constants (sourced from seo/hvac-image-prompts/air-duct-cleaning.md) ───

const HERO_PROMPT =
  "Photo of an HVAC technician kneeling on a residential hallway floor, feeding a heavy-duty rotary duct-cleaning vacuum hose into a large HVAC return air register, fine dust visibly being extracted into the hose, focused working posture. Technician is wearing a light gray button-up work shirt with a red Gardner Plumbing Co. patch on the left chest, navy work pants, dark navy ball cap with red Gardner logo, black work boots, red Milwaukee tool bag on hip. Register grille removed and leaning against the baseboard, dust motes visible in the air near the hose. Warm residential interior light, neutral walls and wood-look floor. 50mm equivalent lens, documentary photography style. No studio lighting. Style and likeness of attached reference image.";

const HERO_NEGATIVE =
  "no stock photo look, no white lab coat, no safety vest, no Carhartt tan jacket, no orange or yellow hi-vis vest, no cartoon, no illustration, no text overlay, no watermark, no industrial dust mask theatrics, no exaggerated black mold imagery, no excessive lens flare";
...
const BEFORE_AFTER_PROMPT =
  "Split-scene product photograph, single frame divided at vertical center. LEFT HALF: endoscope camera POV looking into a residential duct interior — heavy dust and debris coating the sheet metal walls, dark particulate layer, cobwebs at a joint, dim view suggesting years of buildup. RIGHT HALF: the same duct interior after professional cleaning — sheet metal surfaces visible and relatively clean, no dust layer, no debris, slightly brighter ambient look from the clean walls. Seamless lighting match across both halves, straight-on 35mm lens, no people, no hands, technical documentation style. Raw sheet-metal duct-interior as background.";

const BEFORE_AFTER_NEGATIVE =
  "no people, no hands visible, no text overlay, no cartoon, no split-screen border or line artifact, no wildly different lighting between halves, no stock photo softness, no watermark, no exaggerated black mold, no extreme horror-level contamination, no industrial setting";
...
const services = [
  {
    ...
    description:
      "Every supply line and return duct cleaned under negative pressure — NADCA-standard methodology that removes debris without spreading it through the home.",
    features: [
      "Negative Pressure Vacuum",
      "Supply Line Cleaning",
      "Return Duct Cleaning",
      "Branch Line Agitation",
    ],
  },
  {
    icon: Search,
    ...
    description:
      "Camera inspection of your duct interior before we start and after we finish — you see exactly what was in there and exactly what we removed.",
    features: [
      "Pre-Clean Camera Inspection",
      "Post-Clean Verification",
      "Mold & Damage Spotting",
      "Photo/Video Report",
    ],
  },
  {
    ...
    description:
      "Supply and return registers pulled, cleaned, and reinstalled. Boot interiors vacuumed and wiped — the sections most overlooked by discount cleaning operations.",
    features: [
      "Register Removal & Clean",
      "Boot Interior Vacuuming",
      "Diffuser Reinstall",
      "Airflow Spot-Check",
    ],
  },
  {
    ...
    description:
      "When inspection reveals mold growth or significant allergen buildup, we address it directly — not with a spray-and-bill approach, but with source identification and targeted treatment.",
    features: [
      "Mold Source Identification",
      "EPA-Registered Treatment",
      "Moisture Source Referral",
...
const benefits = [
  {
    ...
    description:
      "Our cleaning follows the NADCA Air Systems Cleaning Specialist methodology — negative pressure, agitation, and full containment. Not a \"blow and go\" service.",
  },
  {
    icon: Video,
    title: "Before & After Video Proof",
    description:
      "You receive a camera inspection report showing duct conditions before we start and after we finish. Every home. Every time.",
  },
  {
    icon: Shield,
    title: "Licensed HVAC Technicians",
    description:
      "The same technicians who service your AC and furnace clean your ducts — they know the system, the airflow paths, and what normal looks like.",
  },
  {
    icon: LinkIcon,
    title: "Complete the System Upgrade",
    description:
      "After cleaning, our team can install air filtration systems — MERV 13+ media filters or electronic air cleaners that keep ducts cleaner between service visits.",
  },
];
...
const faqs = [
  {
    ...
    answer: (
      <>
        The EPA and NADCA recommend considering duct cleaning every 3 to 5 years
        under normal conditions. In the Inland Empire, that interval shortens for
        homes near desert-facing areas like Lake Elsinore, Hemet, or Perris —
        where fine particulate and dust infiltration is higher. Homes that
        experienced wildfire smoke intrusion, recent renovation work, or a rodent
        issue should be cleaned regardless of the last service date. Our
        technician does a camera inspection first so you&apos;re not guessing.
        See our{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        AC maintenance focuses on the mechanical equipment — the condenser unit,
        evaporator coil, refrigerant level, and electrical components. Duct
        cleaning focuses on the distribution system — the metal and flex ducts,
        register boots, and air handler cabinet. They complement each other. Our{" "}
        <Link
        ...
        includes a coil inspection and blower check; duct cleaning extends that
        work into the full delivery path. Many Inland Empire homeowners schedule
        both in the same visit for efficiency.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Common signs include a musty or damp smell when the system runs, visible
        dark staining around supply registers, or occupants reporting allergy
        symptoms that improve when the HVAC is off. Mold in ductwork typically
        traces back to a moisture source — a condensate drain issue, a duct leak
        near an unconditioned attic space, or high indoor humidity. Our camera
        inspection identifies whether growth is present and where. If mold is
...
export function AirDuctCleaning() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Inland Empire homes collect dust, allergens, and wildfire
                particulates inside their ductwork. Our HVAC technicians clean
                the full system — supply lines, return lines, and register boots
                — with video documentation before and after.
              </p>

              {/* Key Benefits */}
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Wind, text: "Whole-Home Duct Cleaning" },
                  { icon: Shield, text: "Licensed HVAC Technicians" },
                  { icon: Video, text: "Before & After Documentation" },
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/air-duct-cleaning-hero.webp"
                  alt="Gardner HVAC technician cleaning air ducts at a return register in a Murrieta Inland Empire home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Noticing dust buildup, a musty smell, or reduced airflow?
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Same-week scheduling · licensed HVAC team
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Inland Empire homes deal with desert dust, seasonal wildfire smoke,
              and year-round pollen — all of it pulled through your ductwork
              every time the system runs. Our HVAC technicians clean the full
              duct system using NADCA Air Systems Cleaning Specialist
              methodology: negative pressure, high-efficiency vacuuming, and
              agitation throughout every branch line. View{" "}
              <Link
                href="/services/hvac/indoor-air-quality"
                className="text-red-400 hover:text-red-300 underline"
              >
                all indoor air quality services
              </Link>
              .
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "Visible dust and debris removed from every duct branch",
                    "Allergen load reduced across supply and return paths",
                    "Airflow improved at supply registers — measurable before and after",
                    "Wildfire particulate and smoke residue cleared from duct walls",
                    "Mold and microbial growth identified and treated at the source",
                    "System efficiency improved — less strain on the air handler and blower",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/hvac/air-duct-cleaning-before-after.webp"
                    alt="Before and after air duct cleaning showing dusty duct interior cleared by Gardner HVAC service in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. HVAC technician and service van ready for air duct cleaning"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Unlike carpet-cleaning companies that offer duct cleaning as
                an upsell, our HVAC technicians understand the full system — so
                if they find a damaged flex duct, a disconnected boot, or early
                mold growth, they can address it directly on the same visit. You
                can also view our{" "}
                <Link
                ...
                to keep ducts cleaner between service visits.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Air duct cleaning service is available across the Inland Empire,
              with fast scheduling from our Murrieta base. We serve Temecula,
              Menifee, Perris, Canyon Lake, Lake Elsinore, Corona, Moreno Valley,
              Riverside, and Hemet — same-week availability throughout.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about air duct cleaning in
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                your duct cleaning service. Need immediate help? Call our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Most air duct cleaning is scheduled, not emergency. But some
                situations need faster attention — a wildfire smoke event, a mold
                discovery during a renovation, or post-flood remediation where
                ductwork was exposed to moisture. Our scheduling line is available
                Monday through Saturday, with same-week availability across the
                Inland Empire.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner HVAC team arriving for urgent air duct cleaning service in the Inland Empire"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Whole-home air duct cleaning across Murrieta, Temecula, and the
                Inland Empire. NADCA-standard process, before-and-after video
                documentation, and licensed HVAC technicians on every job. Call
                now or schedule online — same-week availability.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-center text-sm max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">NADCA-Standard Process</span>
              </div>
              <div className="flex items-center gap-2">

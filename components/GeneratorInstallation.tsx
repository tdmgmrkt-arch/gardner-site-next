...
// ─── Image prompt constants (sourced from seo/electrical-image-prompts/generator-installation.md) ───
...
const services = [
  {
    ...
    description:
      "A manual transfer switch isolates your home from SCE's grid when the generator runs, preventing dangerous back-feed. We install the switch, wire selected circuits through it, and confirm the disconnect meets NEC 702 requirements.",
    features: [
      "Grid Isolation Confirmed",
      "NEC 702 Compliant",
      "Selected Circuit Hookup",
      "Proper Disconnect Installed",
    ],
  },
  {
    icon: Cpu,
    ...
    description:
      "An automatic transfer switch detects grid loss and switches your home to generator power within seconds — no manual switching required. Our electricians size the ATS to your generator's output and wire it to the circuits designated for standby power.",
    features: [
      "Automatic Grid Detection",
      "ATS Sized to Generator Output",
      "Standby Circuit Configuration",
  ...
  },
  {
    ...
    description:
      "Whole-home standby generators require load management to prevent overloading the generator's rated output. We identify critical circuits, configure load management wiring, and integrate with your existing sub-panel where applicable.",
    features: [
      "Critical Circuit Priority",
      "Load Shed Configuration",
      "Sub-Panel Integration",
      "Generator Interlock Kit Option",
    ],
  },
  {
    icon: Plug,
    ...
    description:
      "A portable generator without a proper inlet box and transfer switch is a code violation and a back-feed risk. We install a generator inlet box, interlock kit or dedicated transfer switch, and route the connection to your designated standby circuits.",
    features: [
...
const benefits = [
  {
    ...
    description:
      "Back-feed onto SCE utility lines is a lethal hazard for utility workers and a fire risk for your home. Every generator hookup we install includes a proper disconnect — no extension cords through windows, no improvised connections.",
  },
  {
    icon: FileCheck,
  ...
  },
  {
    ...
    description:
      "We size transfer switches and configure load management to match your generator's rated output — preventing overloads that damage both the generator and connected appliances.",
  },
  {
    icon: DollarSign,
...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        Yes — if your home has a heat pump or central air conditioning system,
        those systems are entirely electrical and stop working the moment the grid
        goes down. In an Inland Empire summer, losing AC during a PSPS event is a
        health concern, not just a comfort issue. Heat pumps, in particular, have
        no gas backup — if the grid is down, the home has no heating or cooling
        unless a generator is powering the HVAC circuit. A properly sized standby
        generator with the HVAC circuit on the transfer switch keeps your{" "}
        <Link
        ...
        running through an outage. Our electricians configure the load management
        to prioritize HVAC among the critical circuits.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        A portable generator inlet box with interlock kit — the most common
        entry-level hookup — typically runs $800 to $1,500, permit and inspection
        included. A manual transfer switch with selected critical circuits runs
        $1,500 to $3,000 depending on the number of circuits included. An
        automatic transfer switch (ATS) for a whole-home standby generator runs
        $2,500 to $5,000 for the electrical work, not including the generator unit
        itself. All quotes are written before work begins. If the hookup also
        requires a{" "}
        <Link
        ...
        — which some standby systems do depending on amperage — we scope both
        together. Financing is available; see our{" "}
        <Link
          href="/financing"
          className="text-red-400 hover:text-red-300 underline"
        >
...
export function GeneratorInstallation() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-left animate-fade-in">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4 drop-shadow-lg leading-tight">
                Generator Installation in Murrieta —{" "}
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                SCE Public Safety Power Shutoffs hit the Inland Empire every
                summer. When the grid goes down, a generator keeps your home
                running — but only if the electrical hookup is done right. Our
                licensed electricians install transfer switches, manage loads, and
                handle the code-compliant connection.
              </p>
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/generator-installation-hero.webp"
                  alt="Gardner electrician connecting transfer switch wiring during standby generator installation at a Murrieta home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  SCE outage in Murrieta and your generator isn&apos;t connected?
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Transfer switch options assessed · installation scheduled fast
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white text-center mb-8 drop-shadow-lg">
              Generator Electrical Hookup Services in the{" "}
              <span className="text-gradient bg-gradient-to-r from-yellow-400 to-red-500 bg-clip-text text-transparent">
                Inland Empire
              </span>
            </h2>
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              SoCal Edison&apos;s Public Safety Power Shutoff (PSPS) program has
              cut power to parts of Riverside County multiple times in recent
              years — typically during high-wind events when fire risk peaks.
              Summer heat demand also strains the IE grid. Homeowners who have a
              standby or portable generator but no proper transfer switch are
              running an unsafe setup — and potentially back-feeding power onto
              utility lines. Our electricians handle the electrical side of
              generator installation: transfer switch, load management, sub-panel
              integration, and permit. View our{" "}
              <Link
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/generator-installation-before-after.webp"
                    alt="Before and after generator installation showing standby generator and transfer switch added to a Murrieta home by Gardner Electrical"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. electrician and service van ready for generator hookup work"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our electricians have completed over 50 generator hookup
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Generator installation and transfer switch service is available
              across the Inland Empire, dispatched from our Murrieta base. We
              cover Temecula, Menifee, Perris, Canyon Lake, Lake Elsinore, Corona,
              Moreno Valley, Riverside, and Hemet — with scheduling available
              before and after PSPS season.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about generator electrical hookup in
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                is standing by to answer your questions and schedule your generator
                hookup. Need immediate help? Call our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                When You Need Generator Hookup{" "}
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Emergency electrical service — Gardner electrician responding to generator hookup urgency"
                  width={1000}
                  height={700}
                ...
                <div className="absolute top-6 right-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury animate-fade-in bg-black/60 backdrop-blur-md">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">Year-Round</div>
                      <div className="text-gray-300 text-xs">
                        Hookup Scheduling
                      </div>
                    </div>

...
export function MorenoValleyDrainCleaning() {
  const [isModalOpen, setIsModalOpen] = useState(false);

  const emergencyReasons = [
    "New construction drain failures",
    "Development community backups",
    "Rapid settlement pipe shifts",
    "Towngate subdivision issues",
    "Box Springs drainage emergencies",
    "Moreno Valley Ranch problems",
    "Sunnymead tract clogs",
    "Rancho Belago system failures"
  ];

  const services = [
    {
      icon: Camera,
      title: "New Home Drain Inspection",
      description: "Specialized camera inspections verify proper installation in Moreno Valley's newer developments and subdivisions.",
      features: ["New construction focus", "Builder coordination", "Warranty documentation", "Quality verification"]
    },
    {
      icon: Droplets,
      title: "Development Hydro-Jetting",
      description: "Professional hydro-jetting removes construction debris from drain lines in Moreno Valley Ranch and Towngate properties.",
      features: ["Construction debris removal", "Gentle on new pipes", "Thorough cleaning", "Safe for PVC systems"]
    },
    {
      icon: Wrench,
      title: "Subdivision Drain Service",
      description: "Expert drain cleaning throughout Moreno Valley's extensive residential subdivisions and planned communities.",
      features: ["Tract home specialists", "HOA coordination", "Multiple unit service", "Community-focused"]
    },
    {
      icon: Zap,
      title: "Development Emergency Response",
      description: "24/7 emergency service covering Moreno Valley's growing residential areas from Sunnymead to Box Springs.",
      features: ["Citywide coverage", "Rapid response", "New home expertise", "Always available"]
    }
  ];
  ...
  const benefits = [
    {
      icon: Clock,
      title: "Quick Service",
      description: "Fast response throughout Moreno Valley's extensive residential developments and neighborhoods."
    },
    {
      icon: Shield,
      title: "New Construction Experts",
      description: "Specialized experience with newer plumbing systems common in Moreno Valley developments."
    },
    {
      icon: DollarSign,
      title: "Fair Pricing",
      description: "Competitive rates for Moreno Valley homeowners with transparent estimates before work starts."
    },
    {
      icon: Award,
      title: "Development Knowledge",
      description: "Deep familiarity with Moreno Valley's major residential developments and tract homes."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-left animate-fade-in">
              ...
              <div className="inline-flex items-center gap-3 mb-8 px-6 py-3 bg-gradient-to-r from-red-600/20 to-red-500/20 rounded-full border border-red-500/30 backdrop-blur-sm">
                ...
                <span className="text-red-400 font-semibold text-sm uppercase tracking-wider">Moreno Valley Drain Cleaning</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                Moreno Valley <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">Drain Cleaning</span> Specialists
              </h1>

              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Expert drain cleaning for Moreno Valley's residential communities. Serving Sunnymead Ranch, Rancho Belago, Towngate, Box Springs, Moreno Valley Ranch, and all newer developments with specialized expertise.
              </p>
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Professional Moreno Valley drain cleaning service"
                  width={1000}
                  height={600}
                ...
                <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury bg-black/60 backdrop-blur-md">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">MoVal's Preferred</div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-justify">
              Professional Drain Cleaning Services for Moreno Valley Homes
            </h2>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg">
              Specialized <span className="text-gradient bg-gradient-to-r from-blue-400 to-green-600 bg-clip-text text-transparent">Drain Services</span> for Moreno Valley
            </h2>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Advanced drain cleaning solutions designed for Moreno Valley's newer residential developments and communities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner Plumbing technician serving Moreno Valley with professional drain cleaning"
                  width={1000}
                  height={750}
              ...
              <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury bg-black/60 backdrop-blur-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300 text-xs">Serving Moreno Valley</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                Moreno Valley's <span className="text-gradient bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">Trusted</span> Drain Experts
              </h2>

              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Our specialized knowledge of Moreno Valley's newer developments and construction-specific issues ensures effective solutions for your drainage challenges.
              </p>
      ...
      <section className="py-16 sm:py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg">
              Moreno Valley Drain Cleaning <span className="text-gradient bg-gradient-to-r from-blue-400 to-red-600 bg-clip-text text-transparent">Questions</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Answers to common questions from Moreno Valley homeowners about drain cleaning and maintenance.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Drain emergencies strike without warning in Moreno Valley properties. From Sunnymead Ranch to Moreno Valley Ranch, our emergency team responds rapidly with complete equipment.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Emergency drain cleaning response in Moreno Valley"
                  width={1000}
                  height={700}
        ...
        >
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 drop-shadow-lg">
              Professional <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">Drain Cleaning</span> in Moreno Valley
            </h2>

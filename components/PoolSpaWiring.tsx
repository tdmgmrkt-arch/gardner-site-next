...
// ─── Image prompt constants (sourced from seo/electrical-image-prompts/pool-spa-wiring.md) ───
...
const services = [
  {
    ...
    description:
      "Pool bonding connects all metal components — pool shell rebar, pump, heater, handrails — into a single equipotential grid. Required by NEC 680 and CA code.",
    features: [
      "Equipotential Bonding Grid",
      "Metal Component Bonding",
      "Grounding Conductor Install",
  ...
  },
  {
    ...
    description:
      "NEC 680 requires GFCI protection on all pool and spa circuits within specified distances. We install and verify GFCI breakers at the sub-panel for every pool circuit.",
    features: [
      "GFCI Breaker Install",
      "Pool Pump GFCI Circuit",
      "Spa & Hot Tub GFCI",
  ...
  },
  {
    ...
    description:
      "Dedicated pool sub-panels keep pool equipment circuits separated from the home's main panel — required for most pool builds in Murrieta and Riverside County.",
    features: [
      "Sub-Panel Sizing",
      "Feeder Circuit from Main",
      "Pool Equipment Breakers",
  ...
  },
  {
    ...
    description:
      "Pool pump, heater, automation controller, and lighting wiring — including new equipment hookup and fault diagnosis on existing pool electrical.",
    features: [
      "Pump Motor Wiring",
      "Pool Heater Circuit",
      "Automation Controller Hook",
...
const benefits = [
  {
    ...
    description:
      "Pool and spa electrical is one of the most code-regulated residential applications. Our electricians know NEC Article 680 — not just general wiring practice.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "Pool projects involve electrical, plumbing, and sometimes gas. Our multi-trade team coordinates the electrical scope without slowing down the rest of the job.",
  },
  {
    icon: DollarSign,
    title: "Upfront Pricing",
    description:
      "Written quote before work begins. If the existing wiring requires remediation before new work can be added, we document it and price it first.",
  },
];
...
const faqs = [
  ...
  {
    question:
      "How much does pool and spa electrical wiring cost in Murrieta?",
    answer:
  ...
  },
  {
    ...
    answer: (
      <>
        Yes. A pool pump that repeatedly trips its circuit breaker is drawing
        more current than the circuit is rated for — this points to a failing
        motor, a wiring fault, a short in the pump housing, or an undersized
        circuit. Running the pump after it trips the breaker can damage the
        motor and overheat the wiring. It is also a code violation in most cases
        to manually reset a breaker repeatedly without finding the fault. Call
        us before your next swim session — we diagnose pool pump electrical
        faults the same day. For full panel issues, see our{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        before any new pool electrical work also documents the pre-existing
  ...
  },
  {
    ...
    answer: (
      <>
        Yes. Underwater pool lighting in an existing pool uses either 120V or
        low-voltage (12V) fixtures — both require GFCI-protected circuits per
        NEC 680. The 12V systems use a transformer to step voltage down, which
        simplifies some installation requirements. LED pool lights use
        significantly less power than older incandescent pool lights and are a
        common retrofit. Our electricians run the circuit from the sub-panel to
        the light niche location, install the appropriate GFCI protection, and
        test the fixture at operating voltage before the pool is refilled. For
        other outdoor lighting near the pool area, see our{" "}
        <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Pool and spa electrical work is governed by NEC Article 680 for
                good reason — water and electricity have zero margin for error.
                Licensed electricians handle bonding, GFCI circuits, and
                sub-panel wiring across the Inland Empire.
              </p>

              {/* Key Benefits */}
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: ShieldCheck, text: "NEC 680 Compliant" },
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/pool-spa-wiring-hero.webp"
                  alt="Gardner electrician inspecting pool equipment sub-panel wiring and bonding at a Murrieta home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Pool or spa with an electrical fault? Don&apos;t swim until it&apos;s inspected.
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Same-day pool electrical · Murrieta
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              NEC Article 680 establishes strict electrical requirements for
              pools, spas, and hot tubs — bonding grids, GFCI-protected circuits,
              minimum setback distances for outlets and equipment, and specific
              grounding requirements for metal pool components. Inland Empire
              homes with pools built before 2005 often have wiring that no longer
              meets current code. Our electricians handle new pool electrical
              installation, spa hookup, and fault diagnosis on existing pool
              wiring. View{" "}
              <Link
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "Bonding continuity verified across all metal pool components — grid complete",
                    "GFCI breakers installed and tested on every pool and spa circuit",
                    "All equipment within NEC 680 setback distances — no code violations",
                    "Sub-panel load balanced — no overcrowded breaker slots",
                    "Pool pump and heater wiring confirmed at rated amperage",
                    "Grounding conductor continuity tested from sub-panel to equipment",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/pool-spa-wiring-before-after.webp"
                    alt="Before and after pool electrical wiring showing code-compliant GFCI panel and bonding installation by Gardner Electrical in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. electrician and service van ready for pool and spa wiring"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our electricians have completed over 80 pool and spa electrical
                jobs across Riverside County — NEC 680 bonding grids in Canyon
                Lake, spa sub-panel installs in Temecula, and pool pump wiring
                troubleshooting across Murrieta and Lake Elsinore. Pool electrical
                has zero margin for guesswork.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Pool and spa wiring service is available across the Inland Empire,
              with fast response times from our Murrieta base. We cover Temecula,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about pool and spa electrical
              wiring in Murrieta and the Inland Empire.
            </p>
          </div>
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                are standing by to answer your questions about pool and spa
                electrical compliance. Need immediate help? Call our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Pool and spa electrical faults are life-safety emergencies. A
                tingling sensation in the water, a pump that keeps tripping its
                breaker, visible corrosion on bonding connections, or a GFCI
                that trips every time the pool equipment runs — these are not
                situations to assess after the weekend. Our line is live 24
                hours a day.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Emergency electrical service — Gardner electrician responding to pool wiring fault"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3 drop-shadow-lg">
                Ready to{" "}
                <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">
                  Wire Your Pool or Spa the Right Way?
                </span>
              </h2>

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image src="/burst-pipe-emergency.webp" alt="Water spraying from a burst pipe in a residential wall" width={1000} height={600} className="w-full h-[400px] lg:h-[500px] object-cover rounded-3xl"/>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                  <div>
                      ...
                      <p className="text-lg text-gray-300 mb-8 leading-relaxed">A burst pipe is a true emergency. Our teams are available 24/7/365 to provide immediate assistance, stop the water damage, and begin repairs.</p>
                      <div className="mb-8">

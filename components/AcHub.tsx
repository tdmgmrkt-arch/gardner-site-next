...
// ─── Image prompt constants (sourced from seo/hvac-image-prompts/ac-hub.md) ───
...
// Top 4 AC leaf services featured in the card grid
const services = [
  {
    icon: Wrench,
    title: "AC Repair",
    ...
    features: [
      ...
      "Refrigerant Recharge (EPA 608)",
      "Compressor & Coil Service",
    ],
  },
  {
    icon: Zap,
  ...
  },
  {
    ...
    features: [
      "Evaporator & Condenser Coil Clean",
...
const benefits = [
  {
    ...
    description:
      "Most calls booked before noon are on-site the same day. No overnight wait when your home is heating up in July.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "Written quote before work starts. The price on the quote is the price on the invoice — no add-ons after the job.",
  },
  {
    icon: Award,
    title: "30+ Years in the Field",
    description:
      "Three decades serving Riverside County means the team knows every failure mode the Inland Empire climate produces in AC systems.",
  },
];
...
const faqs = [
  {
    ...
    answer: (
      <>
        The threshold most HVAC technicians use: if the repair cost exceeds half
        the price of a new unit AND your system is over 12 years old,
        replacement is usually the smarter financial decision. Inland Empire AC
        systems run harder than units in coastal climates — the heat accelerates
        wear on capacitors, compressors, and refrigerant lines. A system showing
        multiple failures in the same summer is a strong replacement candidate.
  ...
  },
  {
    ...
    answer: (
      <>
        An AC tune-up covers coil cleaning (evaporator and condenser),
        refrigerant level check, electrical component testing (capacitors,
        contactors, wiring), thermostat calibration, airflow measurement, and a
        full visual inspection of the system. Schedule it in February or March —
        before the first Inland Empire heat wave arrives in late April or May.
        ...
        covers all of the above in a single visit.
      </>
    ),
  },
  {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4 drop-shadow-lg leading-tight">
                Air Conditioning Services in Murrieta &{" "}
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Same-day AC repair, new system installation, seasonal tune-ups,
                and mini-split systems — one licensed HVAC team for every
                cooling need in your home.
              </p>
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/ac-hub-hero.webp"
                  alt="Gardner HVAC technician standing beside a residential AC condenser unit in the Inland Empire"
                  width={1000}
                  height={600}
                  priority
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white text-center mb-8 drop-shadow-lg">
              Air Conditioning Services We Offer in the{" "}
              <span className="text-gradient bg-gradient-to-r from-blue-400 to-green-600 bg-clip-text text-transparent">
                Inland Empire
              </span>
            </h2>
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Whether your AC stopped cooling, your system is aging out, your
              energy bills are climbing, or you want to add ductless cooling to
              a room addition — our licensed HVAC team covers every scenario.
              ...
              — smart and programmable thermostat upgrades that make your AC
              system more efficient and easier to control.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "System cooling to the set temperature — not running endlessly without reaching it",
                    "Refrigerant pressure at manufacturer spec — efficient heat transfer restored",
                    "Evaporator and condenser coils clean and moving full airflow",
                    "Electrical components tested — capacitors, contactors, and wiring confirmed safe",
                    "Thermostat calibrated and communicating correctly with the air handler",
                    "Energy consumption back to normal — lower monthly electric bills",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/hvac/ac-hub-before-after.webp"
                    alt="Before and after AC replacement showing old worn condenser unit replaced with new modern unit by Gardner HVAC in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. HVAC technician and service van ready for AC service"
                  fill
              ...
              <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury animate-fade-in bg-black/60 backdrop-blur-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-white font-bold text-sm">1,800+</div>
                    <div className="text-gray-300 text-xs">
                      Cooling Jobs Completed
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our HVAC team has completed over 1,800 cooling jobs across
                Riverside County — from emergency repairs in Canyon Lake to full
                AC replacements in Perris. Every job is quoted upfront and
                completed by a licensed technician.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Air conditioning service is available across the Inland Empire,
              dispatched from our Murrieta base. We cover Temecula, Menifee,
              Perris, Canyon Lake, Lake Elsinore, Corona, Moreno Valley,
              Riverside, and Hemet — same-day AC service availability
              throughout. See also our{" "}
              <Link
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Common questions about AC repair, installation, and maintenance in
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                AC service. Need immediate help? Call our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Some AC failures cannot wait until morning. Complete cooling
                failure, a system tripping the breaker, a refrigerant leak, or
                ice forming on the unit during a Murrieta heat advisory are all
                situations that need same-day attention. Our emergency line is
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3 drop-shadow-lg">
                Ready to{" "}
                <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">
                  Schedule AC Service in Murrieta?
                </span>
              </h2>
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Same-day air conditioning service across Murrieta, Temecula,
                and the Inland Empire. Upfront pricing, licensed technicians,
                and a 24/7 emergency line. Call now or schedule online — our
                HVAC team picks up.
              </p>
            </div>

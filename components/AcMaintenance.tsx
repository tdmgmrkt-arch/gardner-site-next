...
// ─── Image prompt constants (sourced from seo/hvac-image-prompts/ac-maintenance.md) ───
...
const services = [
  {
    ...
    description:
      "20-point inspection covering electrical components, refrigerant pressure, airflow, drain line, and thermostat calibration — every item documented.",
    features: [
  ...
  },
  {
    ...
    title: "Coil Cleaning",
    description:
      "Evaporator and condenser coils cleaned with professional coil cleaner — dirty coils reduce efficiency by 15–30% and are the leading cause of summer failures.",
    features: [
  ...
  },
  {
    ...
    description:
      "Refrigerant pressures checked against manufacturer spec. Low refrigerant isn't normal — if levels are off, we locate the leak before adding refrigerant.",
    features: [
  ...
  },
  {
    ...
    description:
      "Capacitors, contactors, relays, and wiring connections inspected and tested — electrical component failure is the most common cause of no-cool calls in summer.",
    features: [
...
const benefits = [
  {
    ...
    description:
      "Book before April and get first-choice appointment windows — before peak-season demand fills the calendar through July.",
  },
  {
    icon: Shield,
    title: "Licensed HVAC Technicians",
    description:
      "Every technician carries a valid CA HVAC license. Your tune-up is performed by a certified tech, not an apprentice on their first solo call.",
  },
  {
    icon: FileText,
    title: "Written Inspection Report",
    description:
      "Every tune-up includes a written report — items inspected, readings taken, and anything flagged for attention. You keep the report.",
  },
  {
    icon: Award,
    title: "30+ Years Serving the IE",
    description:
      "Three decades in Riverside County means we understand how desert heat degrades capacitors, coils, and refrigerant systems faster than cooler climates.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        pressure check, capacitor and contactor testing, evaporator and
        condenser coil cleaning, drain line flush, blower motor inspection,
        electrical wiring check, thermostat calibration, and airflow measurement
        at the supply registers. Every item is documented on a written inspection
        report that you keep. If we find something that needs repair, we quote it
        separately — the tune-up fee doesn&apos;t change. If your system needs
        more than maintenance, see our{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        Sometimes, yes — but it depends on the cause. A tune-up resolves
        problems caused by dirty coils, low refrigerant, a failing capacitor, or
        a clogged drain. If the root cause is a failed compressor, a cracked heat
        exchanger, or a refrigerant leak too large to patch economically, a
        tune-up won&apos;t fix those — we&apos;ll diagnose the issue and give
        you repair options. If your system needs repair rather than maintenance,
        our{" "}
        <Link
          href="/services/hvac/ac-repair"
          className="text-red-400 hover:text-red-300 underline"
  ...
  },
  {
    ...
    answer: (
      <>
        A standard AC tune-up in the Murrieta and Temecula area runs $89–$149
        for a single-system home, depending on system type and any add-ons like
        drain line treatment or UV bulb replacement. The price is flat-rate and
        quoted upfront — no add-on surprises after the tech arrives. Homeowners
        who enroll in an{" "}
        <Link
        ...
        receive discounted tune-up pricing as part of their annual plan, along
        with priority scheduling and discounts on any repairs needed during the
        plan year.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        A tune-up is a one-time annual service visit. An{" "}
        <Link
          href="/services/hvac/hvac-maintenance-plans"
          className="text-red-400 hover:text-red-300 underline"
        >
        ...
        is an annual contract that includes your AC tune-up plus your furnace
        tune-up, priority scheduling for repair calls, and a discount on parts
        and labor if anything needs fixing between visits. The plan makes sense
        for homeowners who want both systems covered — and for anyone whose home
        has been deferred on maintenance and wants to get ahead of problems. You
        can also{" "}
        <Link
          href="/services/hvac/furnace-maintenance"
          className="text-red-400 hover:text-red-300 underline"
        >
          pair with furnace maintenance
        </Link>{" "}
        if you prefer separate bookings.
      </>
    ),
  },
  {
    question:
      "When is the best time to schedule an AC tune-up in Murrieta?",
    answer:
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4 drop-shadow-lg leading-tight">
                ...
                <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">
                  Annual Maintenance Before the Heat Hits
                </span>
              </h1>
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                A spring tune-up catches worn capacitors, coil buildup, and low
                refrigerant before they become a breakdown at 108°F. Our HVAC
                technicians service your system top to bottom in a single visit.
              </p>

              {/* Key Benefits */}
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: CalendarCheck, text: "Spring Tune-Up Scheduling" },
                  { icon: Shield, text: "Licensed & Insured" },
                  { icon: DollarSign, text: "Upfront Flat-Rate Pricing" },
                  { icon: Wrench, text: "Full 20-Point Inspection" },
                ].map((item, idx) => (
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/hvac/ac-maintenance-hero.webp"
                  alt="Gardner HVAC technician cleaning AC condenser coils during tune-up service in Murrieta Inland Empire"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Don&apos;t skip your spring tune-up — most summer AC
                  breakdowns are traced to deferred maintenance.
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Schedule before peak-season slots fill
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Inland Empire summers are long, hot, and hard on cooling
              equipment. An AC tune-up in Murrieta isn&apos;t optional
              maintenance — it&apos;s the difference between a system that runs
              efficiently all season and one that fails on a 105°F afternoon.
              Our technicians run a full inspection, clean every component that
              affects efficiency, and flag anything that needs attention. Explore
              our{" "}
              <Link
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "Refrigerant pressure confirmed at manufacturer spec — no guessing",
                    "Evaporator and condenser coils clean — full heat-transfer capacity restored",
                    "Capacitor tested and confirmed within spec or replaced proactively",
                    "Drain line clear — no overflow risk during high-humidity operation",
                    "Thermostat calibrated and tested through a full cooling cycle",
                    "Written inspection report showing every item checked and its status",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/hvac/ac-maintenance-before-after.webp"
                    alt="Before and after AC condenser coil cleaning showing debris buildup removed during Gardner HVAC maintenance service in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. HVAC technician and service van ready for AC maintenance"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our HVAC technicians have completed over 1,000 AC tune-ups
                across Riverside County — from single-zone condos in Lake
                Elsinore to multi-zone homes in Temecula wine country. Consider
                bundling your tune-up with an{" "}
                <Link
                  href="/services/hvac/hvac-maintenance-plans"
                  className="text-red-400 hover:text-red-300 underline"
                >
                ...
                to cover both AC and heating in one annual contract.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              AC maintenance service is available across the Inland Empire,
              dispatched from our Murrieta base. We serve Temecula, Menifee,
              Perris, Canyon Lake, Lake Elsinore, Corona, Moreno Valley,
              Riverside, and Hemet — with convenient spring scheduling
              throughout.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about AC tune-ups and maintenance
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                schedule your AC tune-up. Need immediate help? Call our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Sometimes a maintenance visit uncovers a problem that needs
                immediate attention. A failed capacitor found during a tune-up,
                refrigerant pressure that&apos;s critically low, or a compressor
                drawing dangerous amperage — these aren&apos;t
                &quot;schedule for next week&quot; findings. Our technicians
                carry common repair parts and can address many issues the same
                day as the tune-up.
              </p>

              <div className="mb-8">
                <h3 className="text-xl font-bold text-white mb-6">
                  Common Same-Day Findings:
                </h3>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner HVAC technician arriving for AC maintenance and tune-up service in the Inland Empire"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Annual AC maintenance across Murrieta, Temecula, and the Inland
                Empire. Flat-rate pricing, licensed technicians, written
                inspection report. Call now or schedule online — spring slots
                fill fast. Explore our{" "}
                <Link
                  href="/services/hvac/ac"
                  className="text-red-400 hover:text-red-300 underline"
                >
                ...
                that covers both your AC and heating system year-round.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-center text-sm max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">Spring Scheduling</span>
              </div>
              <div className="flex items-center gap-2">

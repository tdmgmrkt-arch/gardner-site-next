      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="lg:col-span-7">
            {/* --- Mobile-only 'Quick Links & About' combined section --- */}
            <div className="glassmorphism-dark rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-luxury hover-lift transition-all duration-500 border border-white/10 lg:hidden">
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                ...
                <ul className="space-y-3 sm:space-y-4">
                  {[
                    ...
                    { name: "Plumbing Help", desc: "Emergency & problem guides", link: "/plumbing-help" },
                  ].map((item, index) => (
                    <li key={index}>
                      <a
                        href={item.link}
            ...
            {/* --- Desktop-only Navigation Links Section --- */}
            <div className="hidden lg:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 h-full">
              {/* About Us */}

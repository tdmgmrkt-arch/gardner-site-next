        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 sm:mb-16 lg:mb-20 animate-fade-in">
            ...
            <p className="text-sm sm:text-base lg:text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Don't take our word for it - hear from satisfied customers who
              trust Gardner Plumbing Co. for all their{" "}
              <Link
                href="/services"
          ...
          <div className="mb-12 sm:mb-16 lg:mb-20 animate-slide-up">
            <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl backdrop-blur-xl border border-white/10 shadow-luxury overflow-hidden hover-lift">
              {/* Banner Header */}
              <div
                className="relative overflow-hidden px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10"
                style={{
                ...
                <div className="relative flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                      <div className="text-lg sm:text-xl font-bold text-white drop-shadow-sm tracking-tight">
                        4.9/5
                      </div>
                      <div className="text-yellow-300 font-medium text-xs sm:text-sm tracking-wide drop-shadow-sm">
                        Excellence Rating
                      </div>
                    </div>
                  </div>
              ...
              <div className="p-4 sm:p-6 lg:p-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                  {reviews.map((review, index) => (
                    <Card
                      key={index}
                      className="group relative border-none overflow-hidden shadow-luxury hover-lift transition-all duration-500 animate-scale-in h-full flex flex-col"
                      style={{
                    ...
                    >
                      ...
                      <div className="relative z-10 flex flex-col h-full">
                        <CardHeader className="text-center pb-3 sm:pb-4 pt-6 sm:pt-8 flex-shrink-0">
                          ...
                          <div className="flex items-center justify-center gap-0.5 sm:gap-1 mb-2 sm:mb-3">
                            {[...Array(review.rating)].map((_, i) => (
                              <Star
                                key={i}
                                className="h-3.5 w-3.5 sm:h-4 sm:w-4 lg:h-5 lg:w-5 text-yellow-400 fill-current drop-shadow-sm"
                              />
                            ))}
                          </div>
                          <h4 className="text-base sm:text-lg lg:text-xl font-bold text-white mb-1 sm:mb-2 group-hover:text-blue-100 transition-colors duration-300">
                            {review.name}
                          </h4>
                        ...
                        <CardContent className="px-4 sm:px-6 pb-6 sm:pb-8 flex flex-col flex-grow">
                          <p className="text-gray-300 mb-4 sm:mb-6 leading-relaxed flex-grow group-hover:text-gray-200 transition-colors duration-300 text-center italic text-sm sm:text-base">
                            "{review.text}"
                          </p>
                ...
                <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-white/10">
                  <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8">
                    ...
                    >
                      <div
                        className="relative overflow-hidden rounded-lg sm:rounded-xl border border-white/20 backdrop-blur-sm hover-lift transition-all duration-300"
                        style={{
          ...
          <div className="glassmorphism-dark rounded-xl sm:rounded-2xl lg:rounded-3xl p-4 sm:p-6 lg:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-6 sm:mb-8 text-sm sm:text-base leading-relaxed max-w-2xl mx-auto">
                Join hundreds of satisfied customers in Temecula, Murrieta,
                Perris, Menifee, Canyon Lake, Lake Elsinore, Corona, Moreno
                Valley, Riverside, and surrounding areas who trust Gardner
                Plumbing Co. for exceptional service. Visit our{" "}
                <Link
                  href="/about-us"
                  className="text-red-400 hover:text-red-300 underline"
                >

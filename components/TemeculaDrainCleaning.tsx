...
export function TemeculaDrainCleaning() {
  const [isModalOpen, setIsModalOpen] = useState(false);

  const emergencyReasons = [
    "Main sewer line backing up",
    "Kitchen drains completely blocked",
    "Bathroom fixtures overflowing",
    "Multiple slow drains throughout home",
    "Foul sewage smell from drains",
  ...
  const services = [
    {
      ...
      description: "State-of-the-art hydro-jetting clears the most stubborn blockages in Temecula homes and businesses.",
      features: ["Removes grease buildup", "Clears tree roots", "Eco-friendly process", "Restores full flow"]
    },
    {
      icon: Camera,
      title: "Video Drain Inspection",
      description: "Advanced camera technology pinpoints exact blockage locations in your Temecula property's drain system.",
      features: ["High-definition imaging", "Locate hidden problems", "Digital documentation", "Preventive diagnostics"]
    },
    {
      icon: Wrench,
      title: "Professional Drain Snaking",
      description: "Expert drain augering breaks through clogs quickly and safely without damaging your pipes.",
      features: ["Multiple cable sizes", "Safe for all pipes", "Quick clog removal", "Minimal disruption"]
    },
    {
      icon: Zap,
      title: "24/7 Emergency Response",
      description: "Round-the-clock emergency drain cleaning service for urgent situations in Temecula and surrounding areas.",
      features: ["Always available", "Rapid dispatch", "Fully equipped trucks", "Holiday service"]
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: "Most Temecula drain cleaning calls are completed the same day with fast technician dispatch."
    },
    {
      icon: Shield,
      title: "Licensed Professionals",
      description: "Fully licensed and insured plumbers trained specifically in advanced drain cleaning techniques."
    },
    {
      icon: DollarSign,
      title: "Transparent Pricing",
      description: "Honest, upfront quotes with no hidden charges or surprise fees for Temecula customers."
    },
    {
      icon: Award,
      title: "Proven Expertise",
      description: "Over 30 years serving Temecula with thousands of successful drain cleaning projects completed."
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-left animate-fade-in">
              ...
              <div className="inline-flex items-center gap-3 mb-8 px-6 py-3 bg-gradient-to-r from-red-600/20 to-red-500/20 rounded-full border border-red-500/30 backdrop-blur-sm">
                ...
                <span className="text-red-400 font-semibold text-sm uppercase tracking-wider">Temecula Drain Cleaning</span>
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                Temecula <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">Drain Cleaning</span> Experts
              </h1>

              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Professional drain cleaning serving all of Temecula, from Old Town to Redhawk and everywhere in between. Fast, effective solutions for clogged drains, slow drainage, and sewer backups with same-day service available.
              </p>
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Professional Temecula drain cleaning service with hydro-jetting equipment"
                  width={1000}
                  height={600}
                ...
                <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury bg-black/60 backdrop-blur-md">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">Temecula's Choice</div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 text-justify">
              Trusted Drain Cleaning Throughout Temecula
            </h2>
            <div className="space-y-4 text-gray-300 text-lg leading-relaxed">
              <p>
                When drains clog in your Temecula home or business, you need fast, professional service from technicians who understand the unique plumbing challenges in our community. From the historic properties in Old Town Temecula to modern developments in Harveston and Wolf Creek, Gardner Plumbing Company has been clearing drains and restoring proper flow for over three decades.
              </p>
              <p>
                Temecula's water quality and established landscaping create specific drainage issues. Hard water minerals accumulate inside pipes, gradually restricting flow. Mature trees common throughout neighborhoods like Temeku Hills and Redhawk send roots searching for water sources - often finding their way into your sewer lines. Our <Link href="/services/plumbing/hydro-jetting" className="text-red-400 hover:text-red-300 underline">hydro-jetting services</Link> effectively address both problems, thoroughly cleaning pipes and cutting through invasive roots.
              </p>
              <p>
                We serve every corner of Temecula, from the wine country estates to the growing communities near Temecula Parkway. Whether you're dealing with a slow bathroom drain, a backed-up kitchen sink, or a complete sewer blockage, our licensed technicians arrive equipped with professional-grade equipment including video inspection cameras, high-pressure hydro-jetters, and various drain snakes to handle any situation.
              </p>
              <p>
                Regular drain maintenance prevents emergency situations. Many Temecula homeowners schedule annual <Link href="/services/plumbing/drain-cleaning" className="text-red-400 hover:text-red-300 underline">professional drain cleaning</Link> to keep their plumbing systems flowing smoothly. This proactive approach saves money by preventing costly <Link href="/services/plumbing/sewer-and-septic" className="text-red-400 hover:text-red-300 underline">sewer repairs</Link> and water damage from backups.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg">
              Complete <span className="text-gradient bg-gradient-to-r from-blue-400 to-green-600 bg-clip-text text-transparent">Drain Solutions</span> for Temecula
            </h2>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
              From routine maintenance to emergency repairs, we provide comprehensive drain cleaning services using the latest technology and proven methods.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner Plumbing Co. technician ready to serve Temecula with professional drain cleaning"
                  width={1000}
                  height={750}
              ...
              <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury bg-black/60 backdrop-blur-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300 text-xs">Serving Temecula</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                Temecula's <span className="text-gradient bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">Trusted</span> Drain Professionals
              </h2>

              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                As a locally-focused plumbing company, we understand the specific needs of Temecula properties. Our technicians know the area, respect your home, and deliver solutions that last.
              </p>
      ...
      <section className="py-16 sm:py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg">
              Temecula Drain Cleaning <span className="text-gradient bg-gradient-to-r from-blue-400 to-red-600 bg-clip-text text-transparent">Questions</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Common questions from Temecula homeowners about drain cleaning, maintenance, and emergency services.
            </p>
          </div>
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury text-center">
            <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">Need Help Now?</h3>
            <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
              Have questions about drain cleaning in Temecula? Our experts are ready to help. For emergencies, we offer <Link href="/services/plumbing/emergency-service" className="text-red-400 hover:text-red-300 underline">24/7 emergency plumbing service</Link>.
            </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Drain emergencies don't wait for business hours. When you're facing a backup or complete blockage in your Temecula home, our emergency team responds fast with fully-equipped trucks ready to solve the problem.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Emergency drain cleaning service responding to Temecula property"
                  width={1000}
                  height={700}
        ...
        >
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 drop-shadow-lg">
              Professional <span className="text-gradient bg-gradient-to-r from-red-400 to-red-600 bg-clip-text text-transparent">Drain Cleaning</span> in Temecula
            </h2>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Serving Old Town, Redhawk, Harveston, Wolf Creek, Temeku Hills, and all Temecula neighborhoods with expert drain solutions.
            </p>

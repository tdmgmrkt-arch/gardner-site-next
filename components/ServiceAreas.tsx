        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-16 items-center">
          ...
          <div className="text-left">
            ...
            <Link href="/service-areas">
              <Button className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white font-semibold px-6 py-3 rounded-xl shadow-lg border border-red-400/20 transition-all duration-300 group">
                <MapPin className="h-5 w-5 group-hover:scale-110 transition-transform duration-300" />
                See Our Full Service Area
                <span className="text-lg group-hover:translate-x-0.5 transition-transform duration-300" aria-hidden="true">→</span>
              </Button>
            </Link>
          </div>

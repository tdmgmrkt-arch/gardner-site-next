...
const faqs = [
  ...
  },
  {
    ...
    a: "No. Gardner Plumbing Co. does not charge trip fees or service-call fees to any of our 25 service cities. The Gardner Promise includes free in-home estimates and no dispatch fee — regardless of whether the call is in Murrieta or Palm Desert.",
  },
  {
    q: "Do you serve commercial properties across the service area?",
    a: "Yes. Gardner Plumbing Co. serves commercial and industrial properties throughout all 25 cities. Commercial plumbing, hydro jetting, backflow prevention, and industrial plumbing services are available across the full service area. Call (951) 246-4337 to discuss scope and scheduling.",
  },
  {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-lg text-gray-300 mb-4 leading-relaxed">
                Gardner Plumbing Co. serves 25 cities across Riverside County, eastern San
            ...
            <div className="lg:col-span-5">
              <div className="relative w-full aspect-4/5 lg:aspect-3/4 rounded-3xl overflow-hidden shadow-luxury border border-white/10">
                <Image
                  ...
                  alt="Gardner Plumbing Co. service van driving through a Southern California residential neighborhood serving 25 cities across Riverside County and the Coachella Valley"
                  fill
                  priority

...
// ─── Image prompt constants (sourced from seo/hvac-image-prompts/ac-installation.md) ───
...
const services = [
  {
    ...
    description:
      "Manual J load calculations sized to your home's square footage, insulation level, window exposure, and Inland Empire climate data.",
    features: [
  ...
  },
  {
    ...
    description:
      "Full split-system installation — outdoor condenser, indoor air handler, refrigerant line set, electrical disconnect, and thermostat wiring.",
    features: [
      "Carrier & Trane Systems",
      "SEER2-Rated Equipment",
      "Refrigerant Line Installation",
      "Electrical & Disconnect Work",
    ],
  },
  {
    icon: Wrench,
    ...
    description:
      "Old R-22 system at end of life? We remove the old unit, upgrade refrigerant lines if needed, and install a modern R-410A or R-32 system.",
    features: [
  ...
  },
  {
    ...
    description:
      "Every installation ends with a full system startup: refrigerant charge verification, airflow measurements, thermostat calibration, and homeowner walkthrough.",
    features: [
...
const benefits = [
  {
    ...
    description:
      "Undersized systems never catch up in July heat. Oversized systems short-cycle and wear out early. We calculate the right tonnage before any equipment is ordered.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "You receive a written quote with equipment and labor broken out before we order anything. The number on the quote matches the number on the invoice.",
  },
  {
    icon: Award,
...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        A single-zone central AC replacement in a typical Inland Empire home
        (1,500–2,500 sq ft) ranges from $4,500 to $9,000 depending on system
        size, equipment tier, and whether existing ductwork needs modification.
        Full new-construction installs that include ductwork design and
        fabrication run higher. We provide a written itemized quote before any
        work begins — equipment, labor, and permit fees are listed separately.{" "}
        <Link
          href="/financing"
        ...
        are available for qualified homeowners with monthly payment plans
        starting low.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        The standard rule: if the system is under 10 years old and the repair is
        less than half the cost of a new unit, repair usually wins. Systems older
        than 15 years running R-22 refrigerant are typically better candidates
        for replacement — R-22 is no longer manufactured and recharging an old
        system is increasingly expensive. Our technicians give you repair and
        replacement numbers side by side so you can decide without pressure. See
        our{" "}
        <Link
        ...
        for repair-vs-replace guidance.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        A straight AC replacement — removing the old condenser and air handler
        and installing a new matched system — typically takes 4 to 6 hours for
        an experienced two-person crew. New installs that include ductwork
        modifications or an electrical panel upgrade take longer, sometimes two
        days. We give you a time estimate with your quote. Once the system is
        installed, we run a full startup sequence and don&apos;t leave until
        every zone is confirmed cooling. Protect your new system with{" "}
        <Link
...
export function AcInstallation() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Our licensed HVAC technicians size, select, and install your new
                AC system correctly the first time — so it runs efficiently
                through every Inland Empire summer.
              </p>

              {/* Key Benefits */}
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Ruler, text: "Proper Load Calculation" },
                  { icon: Shield, text: "Licensed & Insured" },
                  { icon: DollarSign, text: "Upfront Installation Pricing" },
                  { icon: Star, text: "Carrier & Trane Systems" },
                ].map((item, idx) => (
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/ac-installation-hero.webp"
                  alt="Gardner HVAC technician installing a new AC condenser unit at a Murrieta Inland Empire home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Don&apos;t wait for the next heat wave — schedule your AC
                  installation now.
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  New system running before Inland Empire temps hit 100°F
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Installing a new AC system in an Inland Empire home takes more
              than swapping hardware. Proper Manual J load calculation, correct
              refrigerant line sizing, and airflow balancing determine whether
              your new system cools efficiently for 15–20 years or struggles
              from day one. Our HVAC technicians handle every step, from sizing
              to startup. View our{" "}
              <Link
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "System sized correctly for your home's actual heat load — not a guess",
                    "Refrigerant charged to manufacturer spec, verified with gauges",
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/hvac/ac-installation-before-after.webp"
                    alt="Before and after AC installation showing empty concrete pad replaced with new condenser unit by Gardner HVAC in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. HVAC technician and service van ready for AC installation"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our HVAC team has installed over 500 cooling systems across
                Riverside County — from single-zone replacements in Canyon Lake
                to full-home central air builds in new construction in Menifee.
                Financing options available for qualified homeowners — ask about{" "}
                <Link
                  href="/financing"
                  className="text-red-400 hover:text-red-300 underline"
                >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              AC installation service is available across the Inland Empire,
              dispatched from our Murrieta base. We serve Temecula, Menifee,
              Perris, Canyon Lake, Lake Elsinore, Corona, Moreno Valley,
              Riverside, and Hemet — with same-week installation scheduling
              throughout.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about AC installation in Murrieta
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                schedule your AC installation. Need immediate help? Call our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                ...
                <span className="text-gradient bg-gradient-to-r from-red-400 to-orange-500 bg-clip-text text-transparent">
                  AC Installation Help
                </span>
              </h2>

              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Some situations can&apos;t wait for a standard appointment slot.
                A failed compressor that&apos;s beyond repair, a system shutdown
                during a July heat advisory, or a landlord facing habitability
                concerns — all require faster scheduling than a typical
                new-install job. Call (951) 246-4337 for priority scheduling
                when your situation is time-sensitive.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner HVAC technician and service van arriving for AC installation in the Inland Empire"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                New AC installation across Murrieta, Temecula, and the Inland
                Empire. Proper load calculation, trusted equipment, upfront
                pricing, and licensed technicians. Call now or schedule online
                — we size and install the right system for your home. View our{" "}
                <Link
                  href="/services/hvac/ac"
                  className="text-red-400 hover:text-red-300 underline"
                >
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-center text-sm max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">Expert Sizing</span>
              </div>
              <div className="flex items-center gap-2">

...
// ─── Image prompt constants (sourced from seo/electrical-image-prompts/outlets-and-switches.md) ───
...
const services = [
  {
    ...
    description:
      "GFCI outlets required by CA code in kitchens, bathrooms, garages, and outdoor locations — installed to current NEC and California standards.",
    features: [
      "Kitchen GFCI Circuits",
  ...
  },
  {
    ...
    description:
      "USB-integrated outlets eliminate adapter clutter at countertops and desks. Smart outlets add remote control and scheduling for lamps and small appliances.",
    features: [
      "USB-A & USB-C Ports",
      "Smart Outlet Install",
      "Counter & Desk Placement",
      "Dedicated Circuit Check",
    ],
  },
  {
    icon: Sliders,
    ...
    description:
      "Dimmer switches, 3-way switch wiring, and smart switch installation for rooms where standard toggle switches no longer fit the job.",
    features: [
      "LED-Compatible Dimmers",
      "3-Way Switch Wiring",
      "Smart Switch Install",
      "Switch Loop Replacement",
    ],
  },
  {
    icon: Plus,
    ...
    description:
      "Adding an outlet where none exists — dedicated circuits for home offices, kitchen counters, garages, and outdoor entertaining areas.",
    features: [
      "Dedicated Circuit Add",
      "Home Office Outlets",
...
const benefits = [
  {
    ...
    description:
      "Most outlet and switch jobs are diagnosed and completed the same day — no multi-day wait for a straightforward upgrade.",
  },
  {
    icon: Shield,
    title: "Code-Compliant Installation",
    description:
      "Every outlet is installed to current NEC standards and California code requirements — no shortcuts that fail inspection.",
  },
  {
    icon: DollarSign,
    title: "Upfront Pricing",
    description:
      "Written quote before any work starts. No add-ons discovered after the wall is open. The quote price is the invoice price.",
  },
  {
    icon: Award,
    title: "30+ Years in the Inland Empire",
    description:
      "Three decades serving Riverside County. We know the wiring standards in homes built in every decade from the &apos;60s through today.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        California follows the NEC closely: GFCI protection is required in
        kitchens (any outlet within 6 feet of a sink), bathrooms, garages,
        outdoor locations, unfinished basements, crawl spaces, and anywhere near
        a pool or spa. Many Inland Empire homes built before 1999 are missing
        GFCI protection in one or more of these locations. A failed GFCI outlet
        can also disable multiple downstream outlets on the same circuit —
        that&apos;s often the cause of a &quot;dead outlet&quot; that has no
        obvious fault. For dead outlets that may signal a wiring issue, see our{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        Usually not — but it depends on what else is affected. A single dead
        outlet is often a tripped GFCI somewhere upstream on the same circuit.
        Reset the GFCI outlet in the nearest bathroom or kitchen and test again.
        If the outlet still doesn&apos;t work, or if you smell burning or see
        scorch marks, call us same-day. Don&apos;t use an outlet that shows burn
        marks or feels warm to the touch. If you need it addressed right away,
        our{" "}
        <Link
          href="/services/electrical/electrical-repairs"
          className="text-red-400 hover:text-red-300 underline"
        >
          electrical repairs team
        </Link>{" "}
        handles same-day diagnostic calls.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Adding a new circuit or extending wiring to a new outlet location
        typically requires a permit from the City of Murrieta Building & Safety
        Division. Replacing an existing outlet on the same circuit generally
        does not. Permits are the homeowner&apos;s responsibility under
        California law; we can coordinate the paperwork when needed and will
        list any permit fees as a pass-through line on your quote. For larger
        electrical projects — like adding outlets alongside new{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        A standard dimmer switch reduces voltage to dim a fixture — it has no
        wireless capability. A smart switch connects to your home&apos;s Wi-Fi
        and allows remote control, scheduling, and voice commands through Google
        Home or Amazon Alexa. Smart switches also function as manual dimmers
        from the wall. They require a neutral wire in the switch box — older
        Murrieta homes built before the mid-1990s sometimes lack neutral wires
        at switch locations, which requires a wiring update. If you&apos;re
        planning a broader smart home setup, see our{" "}
        <Link
...
export function OutletsAndSwitches() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                Licensed electricians upgrade, replace, and install outlets and
                switches throughout your home — code-compliant work, same-day
                availability across the Inland Empire.
              </p>

              {/* Key Benefits */}
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Plug, text: "GFCI & USB Outlets" },
                  { icon: Shield, text: "Licensed & Insured" },
                  { icon: DollarSign, text: "Upfront Pricing" },
                  { icon: Phone, text: "Same-Day Scheduling" },
                ].map((item, idx) => (
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/outlets-and-switches-hero.webp"
                  alt="Gardner electrician installing a GFCI outlet in a Murrieta kitchen"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Dead outlet? Circuit that keeps tripping?
                </span>
              </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              California code requires GFCI protection in kitchens, bathrooms,
              garages, and any outdoor circuit — and many Inland Empire homes
              built before 2000 are still running non-compliant outlets. Our
              electricians handle everything from a single outlet swap to a
              whole-home GFCI upgrade, new USB-integrated outlets, and smart
              switch installations. View{" "}
              <Link
                href="/services/electrical/fixtures"
                className="text-red-400 hover:text-red-300 underline"
              >
                all electrical installation services
              </Link>
              .
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "GFCI protection confirmed at all code-required locations",
                    "Outlet face flush with wall — no gaps, no angled mounting",
                    "Ground continuity tested at every outlet before job completion",
                    "USB ports verified to charge at rated amperage",
                    "Dimmer switch confirmed compatible with installed LED fixtures",
                    "Circuit breaker load checked — no overloaded circuits left behind",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/outlets-and-switches-before-after.webp"
                    alt="Before and after outlet upgrade showing old two-prong outlet replaced with modern GFCI by Gardner Electrical in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. electrician and service van ready for outlet and switch installation"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our electricians have installed over 500 outlets and switches
                across Riverside County — GFCI upgrades in Canyon Lake homes,
                kitchen outlet additions in Menifee, and smart switch
                installations in Temecula and Wildomar.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Outlet and switch installation is available across the Inland
              Empire, with fast response times from our Murrieta base. We cover
              Temecula, Menifee, Perris, Canyon Lake, Lake Elsinore, Corona,
              Moreno Valley, Riverside, and Hemet — same-day availability
              throughout.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about outlet and switch
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                are standing by to answer your questions and schedule your outlet
                or switch service. Need immediate help? Call our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
                >
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                ...
                <span className="text-gradient bg-gradient-to-r from-red-400 to-orange-500 bg-clip-text text-transparent">
                  Outlet or Wiring Service
                </span>
              </h2>

              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Some outlet and switch problems signal a wiring fault that needs
                attention the same day. Burn marks, a sparking outlet, or a
                circuit that trips every time a device is plugged in are not
                situations to leave for next week. Our line is live around the
                clock.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Emergency electrical service — Gardner electrician responding to outlet fault"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Same-day outlet and switch installation across Murrieta,
                Temecula, and the Inland Empire. Upfront pricing, licensed
                electricians, and a line that picks up. Call now or schedule
                online.
              </p>
            </div>

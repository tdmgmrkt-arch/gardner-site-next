...
// ─── Image prompt constants (sourced from seo/electrical-image-prompts/surge-protection.md) ───
...
const services = [
  {
    ...
    description:
      "A panel-mounted surge protective device (SPD, Type 1 or Type 2) intercepts transient voltage before it reaches any circuit in the home. This is the most effective surge defense available — one device protects every outlet, appliance, and hardwired system in the home.",
    features: [
      "Type 1 or Type 2 SPD per NEC 230.67",
      "Installed at Main Panel",
      "Full-Home Circuit Coverage",
  ...
  },
  {
    ...
    description:
      "Level 2 EV chargers (240V) are among the most surge-vulnerable devices in any home — they sit on a dedicated high-amperage circuit and are connected continuously. A whole-home SPD at the panel protects the charger. Point-of-use protection is also available for the charger's EVSE unit.",
    features: [
      "Whole-Home SPD for Full Protection",
      "Point-of-Use EVSE Protection Option",
      "Compatible with All Level 2 Chargers",
      "Often Installed Alongside EV Charger Work",
    ],
  },
  {
    icon: Thermometer,
    ...
    description:
      "AC control boards and variable-speed compressors are sensitive to voltage transients. A single grid surge can destroy a $600 control board or damage a variable-speed motor — repairs that take your AC out of commission for days during an Inland Empire summer. Whole-home surge protection prevents this.",
    features: [
      "AC Control Board Protection",
      "Variable-Speed Compressor Defense",
      "Compatible with Heat Pumps & Mini-Splits",
      "Paired with Our AC Repair Team",
    ],
  },
  {
    icon: Wifi,
    ...
    description:
      "Smart panels, security systems, home automation hubs, and high-end AV equipment are all surge-vulnerable. A whole-home SPD at the panel, combined with quality point-of-use protection at sensitive equipment, provides layered defense for homes with significant smart home investment.",
    features: [
      "Smart Panel & Hub Protection",
      "Security System Coverage",
      "AV & Home Theater Defense",
      "Layered Point-of-Use Options",
    ],
  },
];
...
const benefits = [
  {
    ...
    description:
      "The 2020 NEC (adopted in California) now requires surge protection on new residential services under NEC 230.67. We install to code, provide the manufacturer documentation, and register the warranty on your behalf.",
  },
  {
    icon: Wrench,
    title: "Paired With Panel Work",
    description:
      "If you are getting a panel upgrade or a new EV charger circuit, surge protection installs most efficiently at the same time. We coordinate the two — no second visit, no second service fee.",
  },
  {
    icon: DollarSign,
    title: "Upfront Installation Pricing",
    description:
      "Whole-home SPD installation pricing is quoted before any work begins. The most common residential installation takes 1–2 hours. You receive a written quote and the work is done the same visit in most cases.",
  },
  {
    icon: Clock,
    title: "Same-Day Installation Available",
    description:
      "Surge protection is not a complex installation. Most whole-home SPD installs are completed the same day the call is placed. We carry Type 1 and Type 2 devices on every truck.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        Yes. The Murrieta and wider Inland Empire area experiences summer
        monsoon thunderstorm activity from roughly July through September.
        Lightning does not need to strike your home directly to cause surge
        damage — a strike to a nearby utility line or transformer sends a
        voltage spike through the distribution system and into homes connected
        to it. The Inland Empire also experiences grid voltage fluctuation events
        during heat waves when SCE manages load across the network. These
        utility-side surges are invisible to homeowners and do damage over time
        to sensitive electronics, EV charging circuits, and variable-speed AC
        compressors. After any storm event, our{" "}
        <Link
          href="/services/electrical/emergency-electrical"
          className="text-red-400 hover:text-red-300 underline"
        >
          emergency electrical team
        </Link>{" "}
  ...
  {
    question:
      "Is surge protection required by California electrical code?",
    answer: (
      <>
        The 2020 National Electrical Code (NEC), adopted in California, added
        Section 230.67 requiring surge protection on new residential electrical
        services. This requirement applies to new construction and service panel
        replacements — not retroactively to existing homes. However, the
        insurance industry in California is paying close attention to surge
        protection as a risk mitigation factor for wildfire-prone and
        storm-prone regions. Homes with documented whole-home surge protection
        may have an advantage in insurance underwriting conversations. An{" "}
        <Link
        ...
        can confirm whether your home&apos;s service panel meets NEC 230.67 if
        you are unsure.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Yes — and EV chargers are among the most important devices to protect
        with whole-home surge protection. A Level 2 EV charger (240V, 48A) stays
        connected to a dedicated high-amperage circuit continuously. A single
        surge event can damage the EVSE unit (the wall-mounted charging unit),
        the car&apos;s onboard charger, or both. Replacing an EVSE unit costs
        $500–$2,000 depending on brand. A panel-mounted SPD protects the entire
        240V circuit. If you are having an{" "}
        <Link
        ...
        , adding whole-home surge protection during the same visit is the most
        cost-efficient time to do it.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        A PSPS (Public Safety Power Shutoff) event from SCE does not itself
        cause surge damage — it is a controlled de-energization. The risk is in
        the restoration. When SCE re-energizes the grid after a PSPS event,
        voltage restoration can be uneven, particularly in areas at the end of a
        distribution circuit. Whole-home surge protection at the panel handles
        the transient voltage spike that can accompany grid restoration. It is
        one of the practical reasons Inland Empire homeowners in Temecula,
        Menifee, and Lake Elsinore — areas that have experienced PSPS events —
        invest in panel-level surge protection. See our{" "}
        <Link
        ...
        if your panel is approaching the end of its service life — old panels
        often fail to protect against restoration transients even with an SPD
        installed.
      </>
    ),
  },
  {
    question:
      "How much does whole-home surge protection cost in Murrieta?",
    answer:
...
export function SurgeProtection() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4 drop-shadow-lg leading-tight">
                Whole-Home Surge Protection in Murrieta —{" "}
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                A panel-mounted surge protective device (SPD) stops voltage
                spikes before they reach your EV charger, AC system, smart home
                devices, and appliances — installed by licensed electricians
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Shield, text: "Full-Home Coverage at the Panel" },
                  { icon: Zap, text: "Protects EV Chargers & AC Units" },
                  { icon: Wifi, text: "Smart Home & Electronics Safe" },
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/electrical/surge-protection-hero.webp"
                  alt="Gardner electrician installing a whole-home surge protector at the main panel in a Murrieta home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Inland Empire summer storm season runs July through September. Surge damage happens fast.
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Schedule before the next event
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white text-center mb-8 drop-shadow-lg">
              Whole-Home Surge Protection Services for{" "}
              <span className="text-gradient bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent">
                Inland Empire Homes
              </span>
            </h2>
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              The Inland Empire gets summer thunderstorms, lightning-induced
              surges, and grid voltage fluctuations from Southern California
              Edison restoration events — all of which send damaging voltage
              spikes through your home&apos;s wiring. A single surge can destroy
              an EV charger ($500–$2,000 to replace), a smart home hub, an AC
              control board ($400–$900), or a refrigerator. A whole-home surge
              protective device installed at the panel costs a fraction of one
              appliance replacement and protects everything in the home. View{" "}
              <Link
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-16 animate-slide-up">
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 via-transparent to-cyan-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-lg"></div>
                  <div className="absolute inset-[1px] bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg"></div>

                  <div className="relative z-10">
                    <CardHeader className="text-center pb-4 pt-8">
                      <div className="relative mb-6">
                        <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-600/30 to-cyan-500/30 rounded-2xl flex items-center justify-center mx-auto group-hover:from-blue-600 group-hover:to-cyan-500 transition-all duration-500 shadow-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-300">
                  {[
                    "Every circuit in the home protected from transient voltage spikes",
                    "EV charger, AC system, and smart home devices all covered by one device",
                    "Manufacturer warranty registered for the SPD unit",
                    "Installation documented — relevant if surge damage claim arises later",
                    "Protection works 24/7 with no homeowner action required after install",
                    "Future panel work coordinated — SPD reinstalled or upgraded as part of any panel upgrade",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/electrical/surge-protection-before-after.webp"
                    alt="Before and after whole-home surge protection installation showing surge protector added to main panel by Gardner Electrical in Murrieta"
                    width={800}
                    height={400}
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. electrician and service van ready for surge protection installation in Murrieta"
                  fill
              ...
              <div className="absolute bottom-6 left-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury animate-fade-in bg-black/60 backdrop-blur-md">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300 text-xs">
                      Whole-Home Surge Systems Installed
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-8 drop-shadow-lg leading-tight">
                ...
                <span className="text-gradient bg-gradient-to-r from-green-400 to-blue-600 bg-clip-text text-transparent">
                  Electrical Team for Surge Protection
                </span>
              </h2>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our electricians have installed over 200 whole-home surge
                protection systems across Riverside County — including SPD
                installations paired with EV charger circuits, panel upgrades,
                and post-storm electrical restorations.
              </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Surge protection installation is available across the Inland
              Empire, with same-day service from our Murrieta base. We cover
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Common questions about whole-home surge protection in Murrieta and
              the Inland Empire.
            </p>
          </div>
              ...
              <div className="p-6 sm:p-8 lg:p-10">
                ...
                >
                  {faqs.map((faq, index) => (
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 via-transparent to-cyan-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl"></div>
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                Our electricians are available to answer your surge protection
                questions and schedule your installation. Most whole-home SPD
                installs are completed the same day you call.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                After a storm event, a lightning strike near your home, or a
                grid restoration following a PSPS shutoff, surge damage to your
                electrical system may already be underway — even if nothing is
                visibly wrong yet. Schedule a same-day surge protection
                installation before the next event. Call (951) 246-4337 for
                immediate availability across the Inland Empire.
              </p>
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {installationTriggers.map((trigger, index) => (
                    <div
                      key={index}
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner Plumbing Co. electrician arriving to install whole-home surge protection in Murrieta"
                  width={1000}
                  height={700}
                ...
                <div className="absolute top-6 right-6 glassmorphism-dark rounded-2xl p-4 border border-white/20 shadow-luxury animate-fade-in bg-black/60 backdrop-blur-md">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-white font-bold text-sm">Same-Day</div>
                      <div className="text-gray-300 text-xs">
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-3 drop-shadow-lg">
                Ready to{" "}
                <span className="text-gradient bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent">
                  Protect Your Home from the Next Surge?
                </span>
              </h2>
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Whole-home surge protection installed across Murrieta, Temecula,
                and the Inland Empire. Panel-mounted SPD, same-day installation,
                licensed electricians, upfront pricing. Call now or schedule
                online.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-center text-sm max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">NEC 230.67 Compliant</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="h-4 w-4 text-green-400" />
                <span className="text-gray-300">Same-Day Installation</span>
              </div>
              <div className="flex items-center gap-2">

...
// ─── Image prompt constants (sourced from seo/hvac-image-prompts/mini-split-ac.md) ───
...
const services = [
  {
    ...
    description:
      "One indoor head unit paired with one outdoor compressor — ideal for a room addition, master bedroom, or space that gets more sun than the rest of the home.",
    features: [
      "Wall-Mount Head Unit",
      "Outdoor Compressor Install",
      "Line Set & Electrical",
      "Single-Room Zone Control",
    ],
  },
  {
    icon: LayoutGrid,
    ...
    description:
      "One outdoor compressor powering 2–5 indoor units in different rooms — each zone controlled independently for homes or offices that need flexible cooling.",
    features: [
      "2–5 Zone Configurations",
      "Independent Zone Control",
      "Single Outdoor Compressor",
      "Mixed Head Unit Types",
    ],
  },
  {
    icon: Wrench,
    ...
    description:
      "Error codes, loss of cooling, drainage issues, or refrigerant leaks — our technicians diagnose and repair all major mini split brands including Mitsubishi, Daikin, and LG.",
    features: [
  ...
  },
  {
    ...
    description:
      "Every mini split installation ends with full commissioning: refrigerant charge verification, airflow testing, remote programming, and a homeowner orientation on operation.",
    features: [
...
const benefits = [
  {
    ...
    description:
      "Mini splits connect through a 3-inch hole in the wall. No duct design, no ceiling work, no major renovation — installation in most homes takes one day.",
  },
  {
    icon: Gauge,
    title: "High-Efficiency Cooling",
    description:
      "Modern mini splits operate at 20–30+ SEER2 — significantly more efficient than central AC systems at the same price point, lowering monthly utility costs.",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      "Three decades in Riverside County. We've installed ductless systems in every type of IE home — from 1970s Riverside ranchers to new Menifee tract houses.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: (
      <>
        It depends on your home&apos;s layout and existing infrastructure.
        Central AC is generally more cost-effective for whole-home cooling in
        homes that already have ductwork in good condition. Mini splits are the
        better choice when a home lacks ductwork, when you&apos;re cooling a
        room addition or garage conversion, or when you need zone-by-zone
        temperature control. In older Murrieta and Temecula homes built before
        central air was standard, mini splits are often the only practical
        option. Compare both on our{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        Most modern mini splits are heat pumps — they provide both cooling and
        heating from the same system. In Inland Empire climates, where winter
        temperatures in Murrieta and Temecula drop into the 30s–40s°F on cold
        nights but rarely below freezing, a mini split heat pump handles heating
        comfortably down to about 15–20°F outdoor temperature. This makes them
        genuinely dual-purpose for the IE market. If you&apos;re considering a
        whole-home heating upgrade, also compare{" "}
        <Link
  ...
  },
  {
    ...
    answer: (
      <>
        Most mini splits use their own wireless remote or a manufacturer app
        rather than a standard thermostat wiring protocol. However, universal
        mini split controllers — like those from Cielo or Sensibo — can bridge
        your existing mini split to smart home systems including Google Home and
        Amazon Alexa without replacing the unit. Some newer Mitsubishi and Daikin
        systems support direct integration with compatible{" "}
        <Link
        ...
        . Ask your technician about compatible control options during your
        installation quote.
      </>
    ),
  },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-left animate-fade-in">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-xl">
                No ductwork? No problem. Our licensed HVAC technicians install
                single-zone and multi-zone mini split systems in Inland Empire
                homes, garages, additions, and commercial spaces — typically in
                one day.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  { icon: Wind, text: "No Ductwork Required" },
                  { icon: Shield, text: "Licensed & Insured" },
                  { icon: Gauge, text: "High-Efficiency SEER2 Systems" },
                  { icon: DollarSign, text: "Upfront Installation Pricing" },
                ].map((item, idx) => (
            ...
            <div className="relative group animate-slide-up">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  src="/hvac/mini-split-ac-hero.webp"
                  alt="Gardner HVAC technician mounting a mini-split air handler on an interior wall in a Murrieta Inland Empire home"
                  width={1000}
                  height={600}
                  priority
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-white font-bold text-lg sm:text-xl">
                  Adding a room addition or garage conversion this summer?
                  Schedule your mini split installation now.
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <span className="text-red-100 font-semibold text-sm sm:text-base">
                  Inland Empire heat makes ductless cooling a necessity
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-lg text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Mini split AC systems solve a problem central AC cannot — targeted
              cooling for spaces without existing ductwork. In the Inland
              Empire, that means room additions, garage conversions, older
              Murrieta and Temecula homes built before central air was standard,
              and commercial offices that need zone control. Our HVAC team
              handles single-zone and multi-zone ductless installations. View
              all{" "}
              <Link
                href="/services/hvac/ac"
                className="text-red-400 hover:text-red-300 underline"
              >
                cooling service options
              </Link>
              .
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-white mb-6">
                  What&apos;s Different After a Professional Mini Split
                  Installation
                </h3>
                <div className="space-y-4 text-gray-300">
                  {[
                    "Zone-by-zone cooling in spaces that had no AC option before",
                    "Refrigerant charge verified at manufacturer spec with gauges",
                    "Line set routed cleanly with proper insulation and weatherproofing",
                    "Electrical disconnect installed at correct amperage for the unit",
                    "Remote programmed and tested — all modes confirmed operational",
                    "Condensate drain routed to proper discharge point, not just anywhere outside",
                  ].map((item, idx) => (
              ...
              <div>
                <div className="relative overflow-hidden rounded-2xl border border-white/10 shadow-luxury w-full h-64">
                  <Image
                    src="/hvac/mini-split-ac-before-after.webp"
                    alt="Before and after mini-split AC installation showing blank wall replaced with installed ductless air handler by Gardner HVAC in the Inland Empire"
                    width={800}
                    height={400}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury group-hover:shadow-2xl transition-all duration-500 h-96 lg:h-full lg:min-h-[600px]">
                <Image
                  ...
                  alt="Gardner Plumbing Co. HVAC technician and service van ready for mini split installation"
                  fill
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed text-[16px]">
                ...
                ). Our HVAC technicians have installed over 200 ductless mini
                split systems across Riverside County — from single-zone garage
                conversions in Canyon Lake to 4-zone commercial installs in
                Menifee. If you&apos;re comparing ductless vs. central air, see
                our{" "}
                <Link
                  href="/services/hvac/ac-installation"
                  className="text-red-400 hover:text-red-300 underline"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Mini split AC installation service is available across the Inland
              Empire, dispatched from our Murrieta base. We serve Temecula,
              Menifee, Perris, Canyon Lake, Lake Elsinore, Corona, Moreno
              Valley, Riverside, and Hemet — same-week installation scheduling
              throughout.
            </p>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 sm:mb-20 animate-fade-in">
            ...
            <p className="text-[16px] text-gray-300 text-center max-w-4xl mx-auto leading-relaxed">
              Find answers to common questions about mini split AC installation
          ...
          <div className="glassmorphism-dark rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 shadow-luxury hover-lift animate-fade-in">
            <div className="text-center">
              ...
              <p className="text-gray-300 mb-8 leading-relaxed max-w-2xl mx-auto">
                ...
                technicians are standing by to answer your questions and
                schedule your mini split installation. Need immediate help? Call
                our{" "}
                <Link
                  href="tel:9512464337"
                  className="text-red-400 hover:text-red-300 underline"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Mini split failures during Inland Empire summer heat can leave a
                room or an entire occupied space without cooling fast. Whether
                it&apos;s a refrigerant leak, a failed compressor, or a unit
                throwing error codes during a heat event, our HVAC team
                diagnoses and responds the same day. Call (951) 246-4337.
              </p>
            ...
            <div className="relative group">
              <div className="relative overflow-hidden rounded-3xl shadow-luxury hover:shadow-2xl transition-all duration-500">
                <Image
                  ...
                  alt="Gardner HVAC technician arriving for emergency mini split service in the Inland Empire"
                  width={1000}
                  height={700}
          ...
          <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-4">
              ...
              <p className="text-lg text-gray-300 mb-6 max-w-lg mx-auto">
                Mini split AC installation across Murrieta, Temecula, and the
                Inland Empire. Single-zone and multi-zone systems, licensed HVAC
                technicians, upfront pricing. Call now or schedule online. View
                our{" "}
                <Link
                  href="/services/hvac/ac"
                  className="text-red-400 hover:text-red-300 underline"
            ...
            <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-center text-sm max-w-2xl mx-auto">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300">Ductless Experts</span>
              </div>
              <div className="flex items-center gap-2">
